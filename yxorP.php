...
class yxorP
{
    ...
    public function __construct($_req)
    {
        ...
        array_push($_plugins, 'blockListPluginAction', 'cookiePluginAction', 'dailyMotionPluginAction', 'headerRewritePluginAction', 'logPluginAction', 'overridePluginAction', 'proxifyPluginAction', 'twitterPluginAction', 'youtubePluginAction');
