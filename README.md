> ⛔️ ***ARCHIVE PENDING***: Without more people getting behind this, it won't go very far. Please click the "star" button to show your support for this endeavour if you think it interesting. Assuming there is at least some enthusiasm for the idea, development will proceed.
...
> 🎥️ ***MAKING OF***: We put up a short video called "Making of the yxorP Proxy" so that anyone who wants to see how the project came together can do so [\[ MAKING OF VIDEO \]](https://4dboard.github.io/proxy-yxorp/docs/movie.mp4)
