<cp-assets>
        ...
        <div class="uk-form" if="{ mode === 'list' }">
            ...
            <div class="uk-grid">
                        ...
                        <div>
                            <span class="uk-button-group uk-margin-right">
                                <button class="uk-button uk-button-large {listmode === 'list' && 'uk-button-primary'}"
                                        ...
                                        class="uk-icon-list"></i></button>
                                <button class="uk-button uk-button-large {listmode === 'grid' && 'uk-button-primary'}"
                                        type="button" onclick="{ toggleListMode }"
                                        aria-label="{ App.i18n.get('Switch to tile-mode') }"><i class="uk-icon-th"></i></button>
                            </span>
                        </div>
                        <div show="{ !opts.typefilter }">
                            <div class="uk-form-select">

                                <span class="uk-button uk-button-large { getRefValue('filtertype') && 'uk-button-primary'} uk-text-capitalize"><i
                                        class="uk-icon-eye uk-margin-small-right"></i> { getRefValue('filtertype') || App.i18n.get('All') }</span>
                        ...
                        <div class="uk-flex-item-1">
                            <div class="uk-form-icon uk-display-block uk-width-1-1">
                                ...
                                <input class="uk-width-1-1 uk-form-large" type="text"
                                       aria-label="{ App.i18n.get('Search assets') }" ref="filtertitle"
                ...
                <div class="uk-flex uk-flex-middle">
                    ...
                    <button class="uk-button uk-button-large uk-button-danger" type="button"
                            onclick="{ removeSelected }" show="{ selected.length }">
                        { App.i18n.get('Delete') }<span class="uk-badge uk-badge-contrast uk-margin-small-left"
                                                        if="{ !this.single }"> { selected.length }</span>
                    </button>

                    <button class="uk-button uk-button-large uk-button-link" onclick="{addFolder}">{ App.i18n.get('Add
                        folder') }
                    </button>
                            ...
                            <ul class="uk-nav uk-nav-dropdown uk-dropdown-close">
                                ...
                                <li>
                                    <a class="uk-form-file">
                                        ...
                                        <input class="js-upload-select" aria-label="{ App.i18n.get('Select file') }"
                                               type="file" multiple>
                                    </a>
                                    <a class="uk-form-file">
                                        <i class="uk-icon-folder-o uk-icon-justify"></i> { App.i18n.get('Folder') }
                                        <input class="js-upload-folder" type="file" title="" multiple directory
                                               webkitdirectory allowdirs>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="uk-margin">
                <ul class="uk-breadcrumb">
                    <li onclick="{ changeDir }"><a title="{ App.i18n.get('Change dir to root') }"><i
                            class="uk-icon-home"></i></a></li>
                    <li each="{folder, idx in foldersPath}"><a onclick="{ parent.changeDir }"
                                                               title="Change dir to { folder.name }">{ folder.name }</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="{modal && 'uk-overflow-container'}" style="padding: 1px 1px;">
                ...
                <div class="uk-margin" if="{ !loading && folders.length }">
                    ...
                    <strong class="uk-text-small uk-text-muted"><i class="uk-icon-folder-o uk-margin-small-right"></i>
                        {folders.length} {App.i18n.get('Folders')}</strong>
                        ...
                        <div class="uk-grid-margin" each="{ folder,idx in folders }">
                            <div class="uk-panel uk-panel-box uk-panel-card">
                                <div class="uk-flex">
                                    ...
                                    <div class="uk-flex-item-1 uk-text-bold uk-text-truncate"><a class="uk-link-muted"
                                                                                                 onclick="{parent.changeDir}">{
                                        folder.name }</a></div>
                                    <div>
                                            ...
                                            <div class="uk-dropdown">
                                                <ul class="uk-nav uk-nav-dropdown uk-dropdown-close">
                                                    ...
                                                    <li class="uk-nav-item-danger"><a class="uk-dropdown-close"
                                                                                      onclick="{ parent.removeFolder }">{ App.i18n.get('Delete') }</a></li>
                                                </ul>
                                            </div>
                                        </span>
                                    </div>
                ...
                <div class="uk-margin" if="{ !loading && assets.length }">
                    ...
                    <strong class="uk-text-small uk-text-muted"><i class="uk-icon-file-o uk-margin-small-right"></i>
                        {count} {App.i18n.get('Assets')}</strong>

                    <div class="uk-grid uk-grid-match uk-grid-small uk-grid-width-medium-1-5"
                         if="{ listmode === 'grid' }">
                                    ...
                                    <div class="uk-position-absolute uk-position-cover uk-flex uk-flex-middle">
                                        <div class="uk-width-1-1 uk-text-center">
                                            <span if="{ asset.mime.match(/^image\//) == null }"><i
                                                    class="uk-h1 uk-text-muted uk-icon-{ parent.getIconCls(asset.path) }"></i></span>
                                            <cp-thumbnail src="{asset._id}" height="150"
                    ...
                    <table class="uk-table uk-table-tabbed" if="{ listmode === 'list' }">
                        ...
                        <tbody>
                        <tr class="{ selected.length && selected.indexOf(asset) !== -1 ? 'uk-selected':''}"
                            each="{ asset,idx in assets }" onclick="{ select }">
                            <td class="uk-text-center">

                                <span if="{ asset.mime.match(/^image\//) == null }"><i
                                        class="uk-text-muted uk-icon-{ parent.getIconCls(asset.path) }"></i></span>
            ...
            <div class="uk-margin uk-flex uk-flex-middle uk-noselect" if="{!loading && pages > 1 }">
                            ...
                            <div class="uk-margin-small-top { pages > 5 && 'uk-scrollable-box' }">
                                <ul class="uk-nav uk-nav-dropdown">
                                    <li class="uk-text-small" each="{k,v in new Array(pages)}"><a
                                            class="uk-dropdown-close" onclick="{ parent.loadPage }"
                                            data-page="{ (v + 1) }"> { App.i18n.get('Page') } {v + 1}</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="uk-button-group uk-margin-small-left">
                    <a class="uk-button uk-button-link uk-button-small" onclick="{ loadPage }"
    ...
    <div class="uk-form" if="{asset && mode === 'edit'}">
        ...
        <div class="uk-margin-top" show="{modal}">
            <button type="button" class="uk-button uk-button-large uk-button-primary" onclick="{ saveAsset }">{
                App.i18n.get('Save') }
            </button>
            <a class="uk-button uk-button-large uk-button-link" onclick="{ cancelAssetEdit }">{ App.i18n.get('Cancel')
                }</a>
        </div>
        ...
        <cp-actionbar show="{!modal}">
            <div class="uk-container uk-container-center">
                ...
                <a class="uk-button uk-button-large uk-button-link" onclick="{ cancelAssetEdit }">{
                    App.i18n.get('Cancel') }</a>
            </div>
        </cp-actionbar>
    </div>
...
<cp-asset>
    ...
    <div class="uk-form" if="{asset}">
        ...
        <ul class="uk-tab uk-flex-center uk-margin" show="{ App.Utils.count(panels) }">
            ...
            <li class="uk-text-capitalize {p.name === panel && 'uk-active'}" each="{p in panels}"><a
            ...
            <div class="uk-width-2-3">
                ...
                <div class="uk-panel uk-panel-box uk-panel-card uk-panel-space">
                    ...
                    <div class="uk-margin-large-top uk-text-center" if="{asset}">
                        <span class="uk-h1" if="{asset.mime.match(/^image\//) == null }"><i
                                class="uk-icon-{ parent.getIconCls(asset.path) }"></i></span>
                        ...
                        <div class="uk-margin-top uk-text-truncate uk-text-small uk-text-muted">
                            <a href="{ASSETS_URL+asset.path}" target="_blank"
                               title="{ App.i18n.get('Direct link to asset') }" data-uk-tooltip><i
                                    class="uk-icon-button uk-icon-button-outline uk-text-primary uk-icon-link"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="uk-width-1-3">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-margin-small-top">
                        <cp-assets-folderselect asset="{asset}"></cp-assets-folderselect>
                    </div>
                </div>
                <div class="uk-margin">
                    <label class="uk-text-small uk-text-bold">{ App.i18n.get('Type') }</label>
                    <div class="uk-margin-small-top uk-text-muted"><span class="uk-badge uk-badge-outline">{ asset.mime }</span>
                    </div>
                </div>
                <div class="uk-margin" if="{asset.colors && Array.isArray(asset.colors) && asset.colors.length}">
                    ...
                    <div class="uk-margin-small-top uk-text-muted">
                        <span class="uk-icon-circle uk-text-large uk-margin-small-right" each="{color in asset.colors}"
                              riot-style="color: #{String(color).replace('#', '')}"></span>
                    </div>
                </div>
                <div class="uk-margin">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-margin-small-top uk-text-primary"><span class="uk-badge uk-badge-outline">{ App.Utils.dateformat( new Date( 1000 * asset.modified )) }</span>
                    </div>
                </div>
                <div class="uk-margin">
...
<cp-assets-folderselect>
    ...
    <div data-uk-dropdown="mode:'click'">
        ...
        <a class="uk-text-muted">
            <i class="uk-icon-folder-o"></i> { asset.folder && folders[asset.folder] ? folders[asset.folder].name :
            App.i18n.get('Select folder') }
        </a>
