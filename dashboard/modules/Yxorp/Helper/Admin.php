...
class Admin extends Helper
{
    ...
    public function init()
    {
        ...
        $this->data->extend([
            ...
            'yxorp' => json_decode($this->app->helper('fs')->read('#root:package.json'), true),
            ...
            'extract' => [
                ...
                'acl' => [
                    'finder' => $this->app->module('yxorp')->hasaccess('yxorp', 'finder')
                ]
            ]
        ]);
    }
    ...
    public function getOption($key, $default = null)
    {
        ...
        if (!isset($this->options[$key])) {
            ...
            $this->options[$key] = $this->app->storage->getKey("yxorp/options", $key, $default);
        }
