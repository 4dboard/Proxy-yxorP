...
?><!doctype html>
<html lang="{{ $app('i18n')->locale }}" data-base="@base('/')" data-route="@route('/')" data-version="{{ $app['yxorp/version'] }}" data-locale="{{ $app('i18n')->locale }}">
<head>
    <meta charset="UTF-8">
...
<body>
                            ...
                            <div class="uk-dropdown app-panel-dropdown uk-dropdown-close">
                                ...
                                <ul class="uk-grid uk-grid-small uk-grid-width-1-2 uk-grid-width-medium-1-4 uk-text-center">
                                    ...
                                    <li class="uk-grid-margin">
                                        <a class="uk-display-block uk-panel-card-hover uk-panel-box uk-panel-space {{ ($app['route'] == '/yxorp/dashboard') ? 'uk-bg-primary uk-contrast':'' }}" href="@route('/yxorp/dashboard')">
                                            <div class="uk-svg-adjust">
    ...
    <script type="riot/tag" src="{{$app->pathToUrl('#config:tags/'.$component->getBasename())}}?nc={{ $app['debug'] ? time() : $app['yxorp/version'] }}"></script>
    @endforeach
