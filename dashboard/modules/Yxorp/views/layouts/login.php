<!doctype html>
<html lang="{{ $app('i18n')->locale }}" class="uk-height-1-1 app-page-login" data-base="@base('/')"
...
<head>
    ...
    {{ $app->assets($app['app.assets.base'], $app['debug'] ? time() : $app['yxorp/version']) }}
    {{ $app->assets(['assets:../inc/uikit/js/components/form-password.min.js'], $app['debug'] ? time() :
    $app['yxorp/version']) }}
    ...
    <form class="uk-form" method="post" action="@route('/auth/check')" onsubmit="{ submit }">
        ...
        <div id="login-dialog" class="login-dialog uk-panel-box uk-panel-space uk-nbfc" show="{!$user}">
            ...
            <div class="uk-form-row">
                ...
                <input ref="user" class="uk-form-large uk-width-1-1" type="text" aria-label="@lang('Username')"
            ...
            <div class="uk-form-row">
                <div class="uk-form-password uk-width-1-1">
                    ...
                    <input ref="password" class="uk-form-large uk-width-1-1" type="password"
                           aria-label="@lang('Password')" placeholder="" required>
        ...
        <p class="uk-text-center" if="{!$user}"><a class="uk-button uk-button-link uk-link-muted"
                                                   href="@route('/auth/forgotpassword')">@lang('Forgot Password?')</a>
        </p>
