    ...
    <div class="uk-grid" data-uk-grid-margin>
        ...
        <div class="uk-width-medium-3-4">
            ...
            <div id="settings-info" class="uk-switcher">
                ...
                <div>
                    ...
                    @if($app->module('yxorp')->isSuperAdmin() && count(getenv()))
            ...
            @trigger("yxorp.settings.infopage.main")
        ...
        <div class="uk-width-medium-1-4">
            ...
            <ul class="uk-nav uk-nav-side" data-uk-switcher="connect:'#settings-info'">
                ...
                @trigger("yxorp.settings.infopage.aside.menu")
            </ul>

            @trigger("yxorp.settings.infopage.aside")
        </div>
        ...
        <script type="view/script">
            ...
            this.on('mount', function() {
                ...
                App.request('/yxorp/utils/getCacheSize').then(function(rsp) {
            ...
            cleanUpCache() {
                ...
                App.callmodule('yxorp:clearCache').then(function(){
                    setTimeout(function(){
                        $this.cleaning = false;
                        $this.cacheSize = 0;
                        $this.update();
            ...
            startJobsRunner() {
                ...
                App.request('/yxorp/utils/startJobRunner').then(function(rsp) {
            ...
            restartJobsRunner() {
                this.JobsRunnerLoading = true;
                App.request('/yxorp/utils/restartJobRunner').then(function(rsp) {
            ...
            stopJobsRunner() {
                this.JobsRunnerLoading = true;
                App.request('/yxorp/utils/stopJobRunner').then(function(rsp) {
