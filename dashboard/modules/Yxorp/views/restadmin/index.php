...
<div class="uk-margin-top uk-form" riot-view>
    ...
    @trigger('yxorp.restadmin.top', [&$keys])
    ...
    <div class="uk-grid uk-grid-large">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-card uk-flex-item-1 uk-margin-right">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-flex uk-flex-middle">
                                <input class="uk-width-1-1 uk-form-large uk-margin-right uk-text-monospace" type="text"
                                       placeholder="@lang('No key generated')" bind="keys.special[{idx}].token"
                                       readonly>
        ...
        <div class="uk-width-1-3">
            @trigger('yxorp.restadmin.aside', [&$keys])
        </div>
    </div>
