                ...
                <div class="uk-panel uk-panel-box uk-panel-card">
                    ...
                    <div class="uk-margin">
                        ...
                        <input aria-label="@lang('Name')" class="uk-width-1-1 uk-form-large" type="text" ref="name"
                               bind="singleton.name" pattern="[a-zA-Z0-9_]+" required>
                    ...
                    <div class="uk-margin">
                        ...
                        <div data-uk-dropdown="pos:'right-center', mode:'click'">
                            <a><img class="uk-display-block uk-margin uk-container-center"
                                    riot-src="{ singleton.icon ? '@url('assets:app/media/icons/')'+singleton.icon : '@url('singletons:icon.svg')'}"
                                ...
                                <div class="uk-grid uk-grid-gutter">
                                    <div>
                                        <a class="uk-dropdown-close" onclick="{ selectIcon }" icon=""><img
                                                    src="@url('singletons:icon.svg')" width="30" icon=""></a>
                                    </div>
                    ...
                    <div class="uk-grid-margin">
                        ...
                        <textarea aria-label="@lang('Description')" class="uk-width-1-1 uk-form-large"
                                  name="description" bind="singleton.description" bind-event="input"
                                  rows="5"></textarea>
                    </div>
            ...
            <div class="uk-width-medium-3-4">
                ...
                <div class="uk-form-row">
                    ...
                    <ul class="uk-tab uk-flex uk-margin">
                        <li class="{ view==='fields' ? 'uk-active':'' }" data-view="fields"><a onclick="{ toggleview }">@lang('Fields')</a>
                        </li>
                        <li class="{ view==='acl' ? 'uk-active':'' }" data-view="acl"><a onclick="{ toggleview }">@lang('Permissions')</a>
                        </li>
                    </ul>
                                ...
                                <div class="uk-flex-item-1">
                                    <div class="uk-margin uk-text-small">
                                        ...
                                        <div class="uk-margin-top">
                                            <field-boolean bind="singleton.acl.public.form"
                                                           label="@lang('Form')"></field-boolean>
                                        </div>
                                        <div class="uk-margin-top">
                                            <field-boolean bind="singleton.acl.public.edit"
                                                           label="@lang('Edit Singleton')"></field-boolean>
                                        </div>
                                        <div class="uk-margin-top">
                                            <field-boolean bind="singleton.acl.public.data"
                                                           label="@lang('Get Singleton Data')"></field-boolean>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="uk-grid">
                                ...
                                <div class="uk-flex-item-1">
                                    <div class="uk-margin uk-text-small">
                                        <strong class="uk-text-uppercase">@lang('Singleton')</strong>
                                        <div class="uk-margin-top">
                                            <field-boolean bind="singleton.acl.{group}.form"
                                                           label="@lang('Form')"></field-boolean>
                                        </div>
                                        <div class="uk-margin-top">
                                            <field-boolean bind="singleton.acl.{group}.edit"
                                                           label="@lang('Edit Singleton')"></field-boolean>
                                        </div>
                                        <div class="uk-margin-top">
                                            <field-boolean bind="singleton.acl.{group}.data"
                                                           label="@lang('Get Singleton Data')"></field-boolean>
                                        </div>
                                    </div>
                                </div>
        ...
        <cp-actionbar>
            <div class="uk-container uk-container-center">
                ...
                <div class="uk-button-group">
                    ...
                    <a class="uk-button uk-button-large" href="@route('/singletons/form')/{ singleton.name }"
                       if="{ singleton._id }">@lang('Show form')</a>
                </div>
