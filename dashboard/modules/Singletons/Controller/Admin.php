...
class Admin extends AuthController
{
    ...
    public function index()
    {
        ...
        foreach ($_singletons as $name => $meta) {
            ...
            $meta['allowed'] = [
                'delete' => $this->module('yxorp')->hasaccess('singletons', 'delete'),
                'create' => $this->module('yxorp')->hasaccess('singletons', 'create'),
    ...
    public function singleton($name = null)
    {
        ...
        if (!$name && !$this->module('yxorp')->hasaccess('singletons', 'create')) {
            return $this->helper('admin')->denyRequest();
        }
    ...
    public function update_data($singleton): bool|array
    {
        ...
        $data['_mby'] = $this->module('yxorp')->getUser('_id');
