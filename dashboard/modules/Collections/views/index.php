...
<div riot-view>
    ...
    <div>
        ...
        <div class="uk-margin uk-clearfix" if="{ App.Utils.count(collections) }">
            ...
            <div class="uk-form-icon uk-form uk-text-muted">
                ...
                <input class="uk-form-large uk-form-blank" type="text" ref="txtfilter"
                       placeholder="@lang('Filter collections...')" aria-label="@lang('Filter collections...')"
            ...
            <div class="uk-float-right">
                <a class="uk-button uk-button-large uk-button-primary uk-width-1-1"
                   href="@route('/collections/collection')">@lang('Add Collection')</a>
            </div>
            @end
        ...
        <div class="uk-width-medium-1-1 uk-viewport-height-1-3 uk-container-center uk-text-center uk-flex uk-flex-middle uk-flex-center"
             if="{ !App.Utils.count(collections) }">

            <div class="uk-animation-scale">

                <p>
                    <img class="uk-svg-adjust uk-text-muted" src="@url('collections:icon.svg')" width="80" height="80"
                         alt="Collections" data-uk-svg/>
                </p>
                <hr>
        ...
        <div class="uk-grid uk-grid-match uk-grid-gutter uk-grid-width-1-1 uk-grid-width-medium-1-3 uk-grid-width-large-1-4 uk-grid-width-xlarge-1-5 uk-margin-top">
            ...
            <div each="{ collection, idx in collections }"
                 show="{ ingroup(collection.meta) && infilter(collection.meta) }">

                <div class="uk-panel uk-panel-box uk-panel-card uk-panel-card-hover">

                    <div class="uk-panel-teaser uk-position-relative">
                        <canvas width="600" height="350"></canvas>
                        <a aria-label="{ collection.label }" href="@route('/collections/entries')/{collection.name}"
                           class="uk-position-cover uk-flex uk-flex-middle uk-flex-center">
                            <div class="uk-width-1-4 uk-svg-adjust" style="color:{ (collection.meta.color) }">
                                <img riot-src="{ collection.meta.icon ? '@url('assets:app/media/icons/')'+collection.meta.icon : '@url('collections:icon.svg')'}"
                    ...
                    <div class="uk-grid uk-grid-small">
                        ...
                        <div data-uk-dropdown="mode:'click'">
                            ...
                            <div class="uk-dropdown">
                                <ul class="uk-nav uk-nav-dropdown">
                                    ...
                                    <li><a href="@route('/collections/entries')/{collection.name}">@lang('Entries')</a>
                                    </li>
                                    <li><a href="@route('/collections/entry')/{collection.name}"
                                           if="{ collection.meta.allowed.entries_create }">@lang('Add entry')</a></li>
                                    <li if="{ collection.meta.allowed.edit || collection.meta.allowed.delete }"
                                        class="uk-nav-divider"></li>
                                    <li if="{ collection.meta.allowed.edit }"><a
                                                href="@route('/collections/collection')/{ collection.name }">@lang('Edit')</a>
                                    </li>
                                    @hasaccess?('collections', 'delete')
                                    <li class="uk-nav-item-danger" if="{ collection.meta.allowed.delete }"><a
                                                class="uk-dropdown-close"
                                                onclick="{ parent.remove }">@lang('Delete')</a></li>
                                    @end
                                    <li class="uk-nav-divider"
                                        if="{ collection.meta.allowed.edit || collection.meta.allowed.entries_delete }"></li>
                                    <li><a href="@route('/collections/trash/collection')/{collection.name}"
                                           if="{ collection.meta.allowed.entries_delete }">@lang('Trash')</a></li>
                                    <li class="uk-nav-divider" if="{ collection.meta.allowed.edit }"></li>
                                    <li class="uk-text-truncate" if="{ collection.meta.allowed.edit }"><a
                                                href="@route('/collections/export')/{ collection.name }"
                                                download="{ collection.meta.name }.collection.json">@lang('Export
                                            entries')</a></li>
                                    <li class="uk-text-truncate" if="{ collection.meta.allowed.edit }"><a
                        ...
                        <div class="uk-flex-item-1 uk-text-center uk-text-truncate"><a
                                    class="uk-text-bold uk-link-muted"
                                    href="@route('/collections/entries')/{collection.name}"
                                    title="{ collection.label }">{ collection.label }</a></div>
                        <div class="panel-footer-aside uk-text-right">
                            <span class="uk-badge" riot-style="background-color:{ (collection.meta.color) }">
                                ...
                                <span class="uk-icon-spinner uk-icon-spin"
                                      if="{ collection.meta.itemsCount == null }"></span>
                            </span>
                        </div>
                    </div>
