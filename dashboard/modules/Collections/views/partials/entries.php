...
<div class="uk-margin-top" riot-view>
    ...
    <div>
        ...
        <div class="uk-margin-top" show="{ !loading && (entries.length || filter) }">
                            ...
                            <div class="uk-position-cover uk-flex uk-flex-center uk-flex-middle">
                                ...
                                <div class="uk-svg-adjust uk-text-primary"
                                    ...
                                    <img src="@url($collection['icon'] ? 'assets:app/media/icons/'.$collection['icon']:'collections:icon.svg')"
                                         width="80" alt="icon" data-uk-svg>
                                </div>
                            </div>
                            <a class="uk-position-cover"
                               href="@route('/collections/entry/'.$collection['name'])/{ entry._id }"></a>
                        </div>
                        ...
                        <div class="uk-margin-top uk-scrollable-box">
                            <div class="uk-margin-small-bottom" each="{field,idy in parent.fields}"
                                ...
                                <a class="uk-link-muted uk-text-small uk-display-block uk-text-truncate"
                                   href="@route('/collections/entry/'.$collection['name'])/{ parent.entry._id }">
                                    <raw content="{ App.Utils.renderValue(field.type, parent.entry[field.name], field, lang) }"
            ...
            <div class="uk-margin-large-top uk-overflow-container uk-viewport-height-1-3"
                ...
                <table class="uk-table uk-table-tabbed uk-table-striped">
                    ...
                    <tr each="{entry,idx in entries}">
                        ...
                        <td><span class="uk-badge uk-badge-outline uk-text-muted">{ App.Utils.dateformat( new Date( 1000 * entry._created )) }</span>
                        </td>
                        <td><span class="uk-badge uk-badge-outline uk-text-primary">{ App.Utils.dateformat( new Date( 1000 * entry._modified )) }</span>
                        </td>
                        <td>
                            ...
                            <div class="uk-margin-small-top { pages > 5 ? 'uk-scrollable-box':'' }">
                                <ul class="uk-nav uk-nav-dropdown">
                                    <li class="uk-text-small" each="{k,v in new Array(pages)}"><a
                                                ...
                                                onclick="{ parent.loadpage.bind(parent, v+1) }">@lang('Page') {v +
                                            1}</a></li>
                                </ul>
                            </div>
                        </div>
