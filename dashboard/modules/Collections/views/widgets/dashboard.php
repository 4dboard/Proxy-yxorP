    ...
    <div class="uk-panel-box uk-panel-card">
        ...
        <div class="uk-panel-box-header uk-flex uk-flex-middle">
            <strong class="uk-panel-box-header-title uk-flex-item-1">
                ...
                <a href="@route('/collections/collection')" class="uk-icon-plus uk-margin-small-left"
                   title="@lang('Create Collection')" data-uk-tooltip></a>
                @end
            </strong>
                ...
                <li>
                    <div class="uk-grid uk-grid-small">
                        <div class="uk-flex-item-1 uk-text-truncate">
                            <a class="uk-link-muted" href="@route('/collections/entries/'.$col['name'])">
                                ...
                                <img class="uk-margin-small-right uk-svg-adjust"
                                     src="@url(isset($col['icon']) && $col['icon'] ? 'assets:app/media/icons/'.$col['icon']:'collections:icon.svg')"
                        ...
                        <div>
                            ...
                            <a class="uk-text-muted" href="@route('/collections/entry')/{{ $col['name'] }}"
                               title="@lang('Add entry')" aria-label="@lang('Add entry')" data-uk-tooltip="pos:'right'">
