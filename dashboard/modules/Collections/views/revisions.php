    ...
    <div class="uk-width-medium-1-3 uk-viewport-height-1-2 uk-container-center uk-text-center uk-flex uk-flex-center uk-flex-middle"
        ...
        <div class="uk-text-muted uk-width-1-1">
            ...
            <div class="uk-margin-large">
                <a class="uk-button uk-button-large uk-button-link" href="@route("/collections/entry/{$collection['name']}/{$entry['_id']}")">@lang('Back
                to entry')</a>
            </div>
        </div>
    </div>
                ...
                <div class="uk-panel uk-panel-box uk-panel-card">
                    <div class="uk-flex uk-flex-middle">
                        ...
                        <div>
                            ...
                            <a class="uk-margin-left uk-button uk-button-large uk-button-link" href="@route("/collections/entry/{$collection['name']}/{$entry['_id']}")">@lang('Back
                            to entry')</a>
                        </div>
                    </div>
                </div>
    ...
    <script type="view/script">
        ...
        removeAll() {
            ...
            App.ui.confirm('Are you sure?', function() {
                ...
                App.request('/yxorp/utils/revisionsRemoveAll', {oid:$this.revisions[0]._oid}).then(function(){
                    $this.revisions = [];
                    $this.update();
                });
            });
        ...
        remove(e) {
            ...
            App.ui.confirm('Are you sure?', function() {
                ...
                App.request('/yxorp/utils/revisionsRemove', {rid:$this.active._id}).then(function(){
                    $this.active = null;
