...
class Admin extends AuthController
{
    ...
    public function index()
    {
        ...
        foreach ($_collections as $collection => $meta) {
            ...
            $meta['allowed'] = [
                'delete' => $this->module('yxorp')->hasaccess('collections', 'delete'),
                'create' => $this->module('yxorp')->hasaccess('collections', 'create'),
    ...
    public function collection($name = null)
    {
        ...
        if (!$name && !$this->module('yxorp')->hasaccess('collections', 'create')) {
            return $this->helper('admin')->denyRequest();
        }
    ...
    public function save_collection(): bool
    {
        ...
        if (!$isUpdate && !$this->module('yxorp')->hasaccess('collections', 'create')) {
            return $this->helper('admin')->denyRequest();
        }
    ...
    public function entry($collection, $id = null)
    {
        ...
        if ($id) {
            ...
            if (!$entry) {
                return yxorp()->helper('admin')->denyRequest();
            }
    ...
    public function save_entry($collection)
    {
        ...
        $entry['_mby'] = $this->module('yxorp')->getUser('_id');
    ...
    public function delete_entries($collection): bool
    {
        ...
        if (count($items)) {
            ...
            $trashItems = [];
            $time = time();
            $by = $this->module('yxorp')->getUser('_id');
