...
(function (r, t, g) {
    ...
    function y(a) {
        if ("keypress" === a.type) {
            let b = String.fromCharCode(a.which);
    ...
    function z(a, b) {
        ...
        if (!e) {
            if (!n) {
                n = {};
                for (let l in k) 95 < l && 112 > l || k.hasOwnProperty(l) && (n[k[l]] = l)
            }
    ...
    function c(a) {
        ...
        function h(a, b, m, f, c, h) {
            ...
            "keyup" === l && v(a) && (b = [a]);
            for (g = 0; g < d._callbacks[a].length; ++g) if (e = d._callbacks[a][g], (f || !e.seq || n[e.seq] === e.level) && l === e.action) {
                let q;
        ...
        function k(a, c, m, f) {
            ...
            for (const d = n[a] = 0; d < c.length; ++d) {
                const p = d + 1 === c.length ? h : e(f ||
                    z(c[d + 1]).action);
                l(c[d], p, f, a, d)
            }
        }
        ...
        function l(a, b, c, f, e) {
            ...
            a = a.replace(/\s+/g, " ");
            const g = a.split(" ");
            1 < g.length ? k(a, g, b, c) : (c = z(a, c), d._callbacks[c.key] = d._callbacks[c.key] || [], h(c.key, c.modifiers, {type: c.action}, f, a, e), d._callbacks[c.key][f ? "unshift" : "push"]({
                callback: b,
        ...
        d._bindMultiple = function (a, b, c) {
            for (let d = 0; d < a.length; ++d) l(a[d], b, c)
        };
        u(a, "keypress", e);
        u(a, "keydown", e);
        u(a, "keyup", e)
    ...
    if (r) {
        ...
        c.addKeycodes = function (a) {
            for (let b in a) a.hasOwnProperty(b) && (k[b] = a[b]);
            n = null
        };
        c.init = function () {
            const a = c(t);
...
/* bind global plugin */
(function (a) {
    const c = {}, d = a.prototype.stopCallback;
    ...
    a.prototype.bindGlobal = function (a, b, d) {
        this.bind(a, b, d);
        if (a instanceof Array) for (b = 0; b < a.length; b++) c[a[b]] = !0; else c[a] = !0
    };
    a.init()
})(Mousetrap);
