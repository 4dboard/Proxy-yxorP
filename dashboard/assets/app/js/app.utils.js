...
(function (App, riot) {
    ...
    App.Utils.isString = function (val) {
        return "string" === typeof val;
    };
    App.Utils.isNumber = function (val) {
        return "number" === typeof val;
    };
    App.Utils.isNumeric = function (val) {
        return !isNaN(parseFloat(val)) && isFinite(val);
    };
    App.Utils.isFunction = function (val) {
        return "function" === typeof val;
    };
    App.Utils.isUndefined = function (val) {
        return "undefined" === typeof val;
    };
    App.Utils.isDefined = function (val) {
        return "undefined" !== typeof val;
    };
    ...
    App.Utils.renderer.asset = function (v) {
        ...
        if (v && v.mime) {
            ...
            if (v.mime.match(/^image\//)) {
                ...
                var url = App.route('/yxorp/utils/thumb_url?src=' + (ASSETS_URL + v.path) + '&w=30&h=30&re=1');
