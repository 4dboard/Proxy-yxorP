...
class Request
{
    ...
    {
        $config = array_merge(['site_url' => '', 'base_url' => '/', 'base_route' => '', 'route' => '/', 'request' => $_REQUEST, 'post' => $_POST, 'cookies' => $_COOKIE, 'query' => $_GET, 'files' => $_FILES, 'server' => $_SERVER, 'headers' => function_exists('getallheaders') ? \getallheaders() : self::getAllHeaders($_SERVER)], $config);
