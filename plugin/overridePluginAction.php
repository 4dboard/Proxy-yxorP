...
class overridePluginAction extends wrapper
{
    ...
    public function onEventWrite()
    {
        ...
        (constants::get(YXORP_RESPONSE)->setContent($this->REWRITE(str_replace(generalHelper::array_merge_ignore(array(constants::get(YXORP_TARGET_DOMAIN)), array_keys((array)constants::get(YXORP_GLOBAL_REPLACE)), array_keys(constants::get(YXORP_TARGET_REPLACE))), generalHelper::array_merge_ignore(array(constants::get(YXORP_SITE_DOMAIN)), array_values((array)constants::get(YXORP_GLOBAL_REPLACE)), array_values(constants::get(YXORP_TARGET_REPLACE))), preg_replace(generalHelper::array_merge_ignore(array_keys(constants::get(YXORP_GLOBAL_PATTERN)), array_keys(constants::get(YXORP_TARGET_PATTERN)), generalHelper::array_merge_ignore(array_values(constants::get(YXORP_GLOBAL_PATTERN)), array_values(constants::get(YXORP_TARGET_PATTERN))), constants::get(YXORP_RESPONSE)->getContent()))));
    }
