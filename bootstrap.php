...
const PATH_CACHE_DIR = __DIR__ . DIRECTORY_SEPARATOR . DIR_APP . DIRECTORY_SEPARATOR . DIR_STORAGE . DIR_CACHE;
const PATH_CACHE_FILE = __DIR__ . DIRECTORY_SEPARATOR . DIR_APP . DIRECTORY_SEPARATOR . DIR_STORAGE . DIR_CACHE . CACHE_KEY . FILE_CACHE;
/**
