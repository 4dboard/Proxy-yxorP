...
class FetchHelper
{
    ...
    {
        IncludeHelper::FILES_CHECK($GLOBALS['SITE_CONTEXT']->DIR_FULL . '/assets', false);
        IncludeHelper::FILES_CHECK($GLOBALS['PLUGIN_DIR'] . '/override/default/assets', false);
        ...
        try {
            ...
            foreach (array('/http') as $_asset) IncludeHelper::FILES_CHECK($GLOBALS['PLUGIN_DIR'] . $_asset, true);
