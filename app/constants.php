...
if (!defined('CHAR_SLASH')) {
    foreach (['YXORP_HTTP_HOST' => 'xn--ply-onb.com', 'YXORP_REQUEST_URI' => $_SERVER['REQUEST_URI'], 'CHAR_SLASH' => '/', 'CHAR_PERIOD' => '.', 'EXT_TEXT' => 'txt', 'VAR_TMP' => 'tmp', 'DIR_LIB' => 'lib' . DIRECTORY_SEPARATOR] as $key => $value) define($key, $value);
