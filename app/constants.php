...
const PATH_CACHE_DIR = dirname(__FILE__) . DIRECTORY_SEPARATOR . DIR_STORAGE . DIR_CACHE;
const PATH_CACHE_FILE = dirname(__FILE__) . DIRECTORY_SEPARATOR . DIR_STORAGE . DIR_CACHE . CACHE_KEY . FILE_CACHE;
