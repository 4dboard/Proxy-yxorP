...
const DIR_APP_STORAGE = 'storage' . DIRECTORY_SEPARATOR;
const DIR_APP_STORAGE_DATA = 'data';
const VAR_DASH_LOWER = CHAR_DASH . CHAR_UNDER;
const FILE_COOKIE_JAR = COOKIE_JAR . VAR_DASH_LOWER . CACHE_KEY . EXT_TEXT;
const VAR_CACHE_STORE = 'CACHE_STORE' . DIRECTORY_SEPARATOR;
const CHAR_UNDER = '_';
const VAR_TEXT = 'text';
const VAR_HTML = 'html';
const VAR_VAR = 'VAR';
