...
class helpers
{
    ...
    public static function localise(array $req): void
    {
        ...
        /* Defining constants. */
        foreach (['YXORP_GUZZLE_URL' => VAR_FETCH . YXORP_REQUEST_URI, 'YXORP_DIR_FULL' => DIR_ROOT . DIR_OVERRIDE . yP::get(SITE_DETAILS)[VAR_FILES]] as $key => $value) define($key, $value);
    ...
    public static function install(): void
    {
        ...
        echo 1;
        echo PATH_DIR_COCKPIT . DIR_STORAGE . COCKPIT_COLLECTIONS;
        exit(is_dir(PATH_DIR_COCKPIT . DIR_STORAGE . COCKPIT_COLLECTIONS)) ? true : false)
