...
class app implements ArrayAccess
{
    ...
    public function __construct(array $settings = [])
    {
        ...
        $this->helpers = new ArrayObject(array_merge(['cache' => '\yxorP\app\lib\http\\Helper\\helperCache', 'fs' => '\yxorP\app\lib\http\\Helper\\filesystem', 'session' => '\yxorP\app\lib\http\\Helper\\session', 'utils' => '\yxorP\app\lib\http\\Helper\\utils'], $this->registry['helpers']));
