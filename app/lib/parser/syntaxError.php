...
final class syntaxError extends InvalidArgumentException implements cannotProcessHostInterface
{
    ...
    public static function dueToInvalidSuffix(hostInterface $publicSuffix, string $type = ''): self
    {
        if ('' === $type) {
    ...
    public static function dueToInvalidLabelKey(hostInterface $domain, int $key): self
    {
