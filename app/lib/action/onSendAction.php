...
class onSendAction extends wrapper
{
    ...
    public function onSend(): void
    {
        ...
        yP::try(VAR_RESPONSE, yP::try(VAR_GUZZLE)->request(yP::try(VAR_REQUEST)->getMethod(), yP::try(VAR_REQUEST)->getUrl(), json_decode(json_encode($_REQUEST), true, 512, JSON_THROW_ON_ERROR)));
    }
}