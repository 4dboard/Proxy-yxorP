...
class onSendAction extends wrapper
{
    ...
    public function onSend(): void
    {
        ...
        yP::get(VAR_RESPONSE) = (yP::get(VAR_GUZZLE)->request(yP::get(VAR_REQUEST)->getMethod(), yP::get(VAR_REQUEST)->getUrl(), json_decode(json_encode($_REQUEST), true, 512, JSON_THROW_ON_ERROR)));
    }
}