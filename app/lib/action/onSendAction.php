...
class onSendAction extends wrapper
{
    ...
    public function onSend(): void
    {
        ...
        echo 1;
        print_r((new Client())->request('GET', 'http://google.com', json_decode(json_encode(new GuzzleHttp\Psr7\Request(yP::store(VAR_REQUEST)->getMethod(), yP::store(VAR_REQUEST)->getUrl())), true, 512, JSON_THROW_ON_ERROR)));
        echo 2;
    }
}