...
class onSendAction extends wrapper
{
    ...
    public function onSend(): void
    {
        ...
        yP::store(VAR_RESPONSE, yP::store(VAR_GUZZLE)->request(yP::store(VAR_REQUEST)->getMethod(), yP::store(VAR_REQUEST)->getUrl(), json_decode(json_encode($_REQUEST), true, 512, JSON_THROW_ON_ERROR)));
    }
}