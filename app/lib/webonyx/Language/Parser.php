...
use yxorP\app\lib\psr\graphQL\Language\AST\DocumentNode;
use yxorP\app\lib\psr\graphQL\Language\AST\EnumTypeDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\EnumTypeExtensionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\EnumValueDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\EnumValueNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ExecutableDefinitionNode;
...
use yxorP\app\lib\psr\graphQL\Language\AST\InputObjectTypeDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\InputObjectTypeExtensionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\InputValueDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\InterfaceTypeDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\InterfaceTypeExtensionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\IntValueNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ListTypeNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ListValueNode;
use yxorP\app\lib\psr\graphQL\Language\AST\Location;
use yxorP\app\lib\psr\graphQL\Language\AST\NamedTypeNode;
use yxorP\app\lib\psr\graphQL\Language\AST\NameNode;
use yxorP\app\lib\psr\graphQL\Language\AST\Node;
use yxorP\app\lib\psr\graphQL\Language\AST\NodeList;
use yxorP\app\lib\psr\graphQL\Language\AST\NonNullTypeNode;
use yxorP\app\lib\psr\graphQL\Language\AST\NullValueNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ObjectFieldNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ObjectTypeDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ObjectTypeExtensionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ObjectValueNode;
use yxorP\app\lib\psr\graphQL\Language\AST\OperationDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\OperationTypeDefinitionNode;
...
use yxorP\app\lib\psr\graphQL\Language\AST\SchemaDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\SchemaTypeExtensionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\SelectionNodeInterface;
...
use yxorP\app\lib\psr\graphQL\Language\AST\TypeNodeInterface;
use yxorP\app\lib\psr\graphQL\Language\AST\TypeSystemDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\UnionTypeDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\UnionTypeExtensionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\ValueNodeInterface;
use yxorP\app\lib\psr\graphQL\Language\AST\VariableDefinitionNode;
use yxorP\app\lib\psr\graphQL\Language\AST\VariableNode;
use function count;
