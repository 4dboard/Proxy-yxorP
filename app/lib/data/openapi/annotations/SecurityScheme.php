...
class SecurityScheme extends AbstractAnnotation
{
     ...
     * @inheritdoc
     */
    public static array $_required = ['securityScheme', 'type'];
    /**
     * @inheritdoc
     */
     ...
     * @var string
     */
    public string $securityScheme = Generator::UNDEFINED;
    /**
     ...
     * @var Flow[]
     */
    public string|array $flows = Generator::UNDEFINED;
    /**
     ...
     * @var string
     */
    public string $bearerFormat = Generator::UNDEFINED;
    /**
     ...
     * @var string
     */
    public string $scheme = Generator::UNDEFINED;
    /**
     * OpenId Connect URL to discover OAuth2 configuration values. This MUST be in the form of a URL.
     *
     * @var string
     */
    public string $openIdConnectUrl = Generator::UNDEFINED;
