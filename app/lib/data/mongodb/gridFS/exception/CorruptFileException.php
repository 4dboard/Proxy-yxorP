...
class CorruptFileException extends RuntimeException
{
     ...
     * @return self
     */
    #[Pure] public static function missingChunk(int $expectedIndex)
    {
     ...
     * @return self
     */
    #[Pure] public static function unexpectedIndex(int $index, int $expectedIndex)
    {
     ...
     * @return self
     */
    #[Pure] public static function unexpectedSize(int $size, int $expectedSize)
    {
