...
class InvalidArgumentException extends DriverInvalidArgumentException implements ExceptionInterface
{
    /**
     ...
     * @return self
     */
    public static function invalidType(string $name, mixed $value, array|string $expectedType)
    {
