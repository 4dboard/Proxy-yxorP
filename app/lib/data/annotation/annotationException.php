...
{
    #[Pure] public static function syntaxError($message)
    {
        return new self('[Syntax Error] ' . $message);
    }

    #[Pure] public static function creationError($message, ?Throwable $previous = null)
    {
    ...
    #[Pure] public static function semanticalError($message)
    {
    ...
    #[Pure] public static function typeError($message)
    {
    ...
    #[Pure] public static function enumeratorError($attributeName, $annotationName, $context, $available, $given)
    {
    ...
    #[Pure] public static function optimizerPlusSaveComments()
    {
        return new self('You have to enable opcache.save_comments=1 or zend_optimizerplus.save_comments=1.');
    }

    #[Pure] public static function optimizerPlusLoadComments()
    {
