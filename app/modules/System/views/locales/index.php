            ...
            <ul class="app-list-items animated fadeIn" v-if="locales && locales.length">
                ...
                <li v-for="(locale, idx) in locales">
                    ...
                    <div class="kiss-margin kiss-flex kiss-flex-middle"
                         :class="{'kiss-color-muted': locale.enabled === false}">
                        ...
                        <div class="kiss-margin-left kiss-size-small kiss-align-right"
                             :class="locale.i18n == 'default' ? 'kiss-color-primary' : 'kiss-color-muted'"><strong>{{
                                locale.i18n }}</strong></div>
                        <a class="kiss-display-block kiss-margin-left kiss-color-danger" @click="remove(locale)">
                ...
                <kiss-container size="small">
                    <div class="kiss-flex kiss-flex-middle kiss-flex-right">
                        <a class="kiss-button kiss-button-primary"
                           href="<?= $this->route('/system/locales/create') ?>"><?= t('Add locale') ?></a>
                    </div>
                </kiss-container>
