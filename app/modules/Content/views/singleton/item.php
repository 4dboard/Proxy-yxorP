    ...
    <div class="kiss-flex kiss-flex-middle">
        <div class="kiss-margin-small-right">
            <kiss-svg class="kiss-margin-auto"
                      src="<?= $this->base(isset($model['icon']) && $model['icon'] ? $model['icon'] : 'content:assets/icons/singleton.svg') ?>"
                      width="30" height="30" style="color:<?= ($this->escape($model['color'] ?? 'inherit')) ?>">
        ...
        <template>
            ...
            <div class="kiss-height-50vh kiss-flex kiss-flex-middle kiss-flex-center kiss-align-center"
                ...
                <div class="animated fadeInUp kiss-color-muted">
                    <kiss-svg class="kiss-margin-auto" src="<?= $this->base('content:assets/icons/singleton.svg') ?>"
                              width="40" height="40">
                    ...
                    <div class="kiss-flex kiss-flex-middle">
                        ...
                        <div class="kiss-button-group">
                            ...
                            <a class="kiss-button kiss-button-primary"
                               :class="{'kiss-disabled': item._id && !isModified}" @click="save()">
                                <?= t('Save') ?>
                            </a>
                        </div>
                    </div>
