            ...
            <form :class="{'kiss-disabled':saving}" @submit.prevent="save">
                ...
                <div class="kiss-margin-large" v-if="!isUpdate">
                    ...
                    <kiss-grid cols="3@m" gap="small">
                        ...
                        <kiss-card class="kiss-flex kiss-padding kiss-position-relative" theme="bordered"
                                   :class="model.type == 'singleton' ? '': 'kiss-color-muted'"
                                   :style="{borderColor:model.type == 'singleton' ? 'var(--kiss-color-primary)': null}">
                            <div class="kiss-margin-small-right">
                                <kiss-svg src="<?= $this->base('content:assets/icons/singleton.svg') ?>" width="30"
                                          height="30">
                        ...
                        <kiss-card class="kiss-flex kiss-padding kiss-position-relative kiss-padding" theme="bordered"
                                   :class="model.type == 'collection' ? '': 'kiss-color-muted'"
                                   :style="{borderColor:model.type == 'collection' ? 'var(--kiss-color-primary)': null}">
                            <div class="kiss-margin-small-right">
                                <kiss-svg src="<?= $this->base('content:assets/icons/collection.svg') ?>" width="30"
                                          height="30">
                                    <canvas width="30" height="30"></canvas>
                                </kiss-svg>
                            </div>
                ...
                <div class="kiss-margin-large" v-if="isUpdate">
                    <kiss-card class="kiss-flex kiss-padding" theme="bordered">
                        <div class="kiss-margin-small-right" v-if="model.type=='singleton'">
                            <kiss-svg src="<?= $this->base('content:assets/icons/singleton.svg') ?>" width="30"
                                      height="30">
                                <canvas width="30" height="30"></canvas>
                            </kiss-svg>
                        </div>
                        <div class="kiss-margin-small-right" v-if="model.type=='collection'">
                            <kiss-svg src="<?= $this->base('content:assets/icons/collection.svg') ?>" width="30"
                                      height="30">
                                <canvas width="30" height="30"></canvas>
                            </kiss-svg>
                ...
                <div class="kiss-margin kiss-margin-large-top">
                    ...
                    <kiss-tabs class="kiss-margin-large">
                        ...
                        <tab :caption="t('Preview')">
                            ...
                            <kiss-card class="animated fadeIn kiss-padding kiss-align-center kiss-text-caption"
                                       theme="bordered contrast" v-if="!model.preview.length">
                            ...
                            <vue-draggable v-model="model.preview" v-if="model.preview.length" handle=".fm-handle">
                                <template #item="{ element }">
                                    <kiss-card class="kiss-flex kiss-flex-middle kiss-margin-small">
                                        <div class="kiss-margin-small-right">
                                            <icon class="kiss-size-3"
                                                  :class="{'kiss-color-muted': !(element.name && element.uri)}">
                                                visibility
                                            </icon>
                                        </div>
                                        ...
                                        <a class="fm-handle kiss-margin-small-left kiss-color-muted">
                            ...
                            <div class="kiss-margin kiss-align-center">
                                <a class="kiss-size-large" @click="model.preview.push({name:'', uri:''})">
                        ...
                        <tab :caption="'Other'">
                            ...
                            <div class="kiss-flex">
                                ...
                                <div>
                                    <icon-picker v-model="model.icon" size="30"></icon-picker>
                                </div>
                            </div>
                    ...
                    <kiss-container size="small">
                        <div class="kiss-flex kiss-flex-middle kiss-flex-right">
                            ...
                            <div class="kiss-flex-1" v-if="isUpdate">
                                <a class="kiss-button" :href="$route(`/content/collection/items/${model.name}`)"
                                   v-if="model.type == 'collection'"><?= t('Goto items') ?></a>
                                <a class="kiss-button" :href="$route(`/content/singleton/item/${model.name}`)"
                                   v-if="model.type == 'singleton'"><?= t('Goto form') ?></a>
                            </div>
            ...
            export default {
                ...
                methods: {
                    ...
                    save() {
                        ...
                        this.$request('/content/models/save', {
                            model: this.model,
