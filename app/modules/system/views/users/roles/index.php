<kiss-container class="kiss-margin-large" size="small">
    ...
    <vue-view>
        <template>
            ...
            <div
                class="animated fadeIn kiss-height-30vh kiss-flex kiss-flex-middle kiss-flex-center kiss-align-center kiss-color-muted"
                ...
                <li v-for="(role, idx) in roles">
                    ...
                    <div class="kiss-margin kiss-flex">
                        ...
                        <div class="kiss-margin-left">
                            <a class="kiss-color-danger" @click="remove(role)">
                    ...
                    <div class="kiss-flex kiss-flex-middle kiss-flex-right">
                        <div class="kiss-button-group">
                            <?php if ($this->helper('acl')->isAllowed('app.users.manage')): ?>
                                <a class="kiss-button"
                                   href="<?= $this->route('/system/users') ?>"><?= t('Manage users') ?></a>
                            <?php endif ?>
                            <a class="kiss-button kiss-button-primary"
                               href="<?= $this->route('/system/users/roles/create') ?>"><?= t('Add role') ?></a>
                        </div>
                    </div>
                </kiss-container>
