    ...
    <vue-view>
        <template>
            ...
            <form :class="{'kiss-disabled':saving}" @submit.prevent="save">
                ...
                <kiss-card class="kiss-margin kiss-padding" theme="bordered contrast"
                           v-for="(permissions, group) in simplePermissions">
                    ...
                    <div class="kiss-margin">
                        <div class="kiss-margin-small kiss-size-small kiss-flex kiss-middle"
                            ...
                            <div>
                                <field-boolean v-model="role.permissions[permission]"></field-boolean>
                            </div>
                ...
                <kiss-card class="kiss-margin kiss-padding" theme="bordered contrast"
                           v-for="(meta, group) in componentPermissions">

                    <strong class="kiss-text-caption">{{ group }}</strong>

                    <div class="kiss-margin">
                        <component :is="meta.component" v-model="role.permissions"
                                   v-bind="meta.props || {}"></component>
                    </div>
