...
<kiss-container class="kiss-margin" size="small">
    ...
    <vue-view>
        <template>
            ...
            <div class="kiss-color-muted kiss-size-small kiss-margin-small-top kiss-margin-large-bottom"
                 v-if="key.key === 'public'">
            ...
            <form :class="{'kiss-disabled':saving}" @submit.prevent="save">
                ...
                <kiss-card class="kiss-margin kiss-padding kiss-position-relative" theme="bordered contrast">
                    ...
                    <div class="kiss-margin">
                        ...
                        <div class="kiss-flex kiss-flex-middle">
                            ...
                            <div class="kiss-margin-left kiss-flex-1 kiss-align-right"><a
                                    ...
                                    <icon class="kiss-size-large">tune</icon>
                                </a></div>
                        </div>
                    ...
                    <div class="kiss-margin" v-if="key.key != 'public'">
                        ...
                        <label>
                            <icon>vpn_key</icon> <?= t('API Key') ?></label>
                        <div class="kiss-flex kiss-flex-middle">
                            <div class="kiss-flex-1 kiss-margin-small-right kiss-text-truncate kiss-disabled">
                                <span class="kiss-text-caption"
                                      v-if="!key.key"><?= t('No api key created yet') ?></span>
                                <span class="kiss-text-monospace kiss-text-bold" v-if="key.key">{{ key.key }}</span>
                            </div>
                            <a @click="generateToken">
                                <icon class="kiss-size-large">refresh</icon>
                            </a>
                            <a class="kiss-margin-small-left" v-if="key.key" @click="copyToken">
                                <icon class="kiss-size-large">content_copy</icon>
                            </a>
                        </div>
