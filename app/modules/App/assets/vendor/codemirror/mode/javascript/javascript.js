...
(function (mod) {
    ...
    CodeMirror.defineMode("javascript", function (config, parserConfig) {
        ...
        const trackScope = parserConfig.trackScope !== false;
        ...
        const keywords = function () {
            ...
            const A = kw("keyword a"), B = kw("keyword b"), C = kw("keyword c"), D = kw("keyword d");
        ...
        function classfield(type, value) {
            ...
            if (value === "=") return cont(expressionNoComma)
            const context = cx.state.lexical.prev, isInterface = context && context.info === "interface";
