<kiss-container class="kiss-margin-large" size="medium">
    ...
    <vue-view>
        <template>
            ...
            <div
                class="animated fadeIn kiss-height-30vh kiss-flex kiss-flex-middle kiss-flex-center kiss-align-center kiss-color-muted kiss-margin-large"
            ...
            <div class="kiss-margin-large" v-if="!loading && models.length">
                        ...
                        <kiss-card class="animated fadeIn kiss-flex" theme="shadowed contrast" hover="shadow"
                            ...
                            <div class="kiss-position-relative kiss-padding-small kiss-bgcolor-contrast kiss-width-1-6">
                                ...
                                <div class="kiss-cover kiss-flex kiss-flex-middle kiss-flex-center">
                                    <div :style="{color: model.color || 'inherit' }">
                                        <kiss-svg :src="$base(model.icon || 'content:assets/icons/singleton.svg')"
                            ...
                            <div class="kiss-padding-small kiss-flex-1">
                                <div class="kiss-flex kiss-flex-middle">
                                    <a class="kiss-flex-1 kiss-margin-right kiss-text-bold kiss-link-muted"
                                       :href="$route(`/content/singleton/item/${model.name}`)">{{ model.label ||
                                        model.name }}</a>
                                    <a @click="toggleModelActions(model)">
                                        <icon>more_horiz</icon>
                                    </a>
                                </div>
                                <div class="kiss-margin-xsmall-top kiss-color-muted kiss-size-xsmall">{{model.info ||
                                    t('Singleton')}}
                                </div>
                            </div>
                        </kiss-card>

                        <kiss-card class="animated fadeIn kiss-padding kiss-flex kiss-flex-middle kiss-flex-center"
                                   theme="bordered" hover="shadow">
                            <a class="kiss-size-large"
                               href="<?= $this->route('/content/models/create') ?>?type=singleton"
                               title="<?= t('Add singleton model') ?>">
                ...
                <div class="kiss-margin-large" v-if="collections.length">
                    ...
                    <div
                        class="kiss-margin kiss-text-caption kiss-text-bold kiss-color-muted kiss-size-small"><?= t('Collections') ?></div>
                            ...
                            <div class="kiss-padding kiss-flex kiss-flex-middle">
                                <div class="kiss-margin-small-right" :style="{color: model.color || 'inherit' }">
                                    <kiss-svg class="kiss-margin-auto"
                                              :src="$base(model.icon || 'content:assets/icons/collection.svg')"
                                              width="30" height="30"></kiss-svg>
                                </div>
                                <div
                                    class="kiss-flex-1 kiss-position-relative kiss-margin-right kiss-text-bold kiss-link-muted">
                                    {{ model.label || model.name }}
                                    <a class="kiss-cover" :href="$route(`/content/collection/items/${model.name}`)"></a>
                                </div>
                                <div class="kiss-color-muted kiss-size-xsmall kiss-margin-right kiss-visible@m "
                                     v-if="model.info">
                                    {{model.info}}
                                </div>
                                <div>
                    ...
                    <div>
                        <kiss-card class="animated fadeIn kiss-padding-small kiss-align-center">
                            <a class="kiss-size-large"
                               href="<?= $this->route('/content/models/create') ?>?type=collection"
                               title="<?= t('Add collection model') ?>">
                                <icon>add_circle_outline</icon>
                            </a>
                        </kiss-card>
                    </div>
                    ...
                    <div class="kiss-flex kiss-flex-middle">
                        ...
                        <?php if ($this->helper('acl')->isAllowed("content/models/manage")): ?>
                            <a class="kiss-button kiss-button-primary"
                               href="<?= $this->route('/content/models/create') ?>"><?= t('Create model') ?></a>
                        <?php endif ?>
                    </div>
                </kiss-container>
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="kiss-flex kiss-flex-middle"
                                   :href="$route(`/content/models/edit/${actionModel.name}`)">
                            ...
                            <li v-if="actionModel.type=='collection'">
                                <a class="kiss-flex kiss-flex-middle"
                                   :href="$route(`/content/collection/item/${actionModel.name}`)">
