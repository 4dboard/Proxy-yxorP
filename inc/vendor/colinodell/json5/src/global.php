...
if (!function_exists('json5_decode')) {
     ...
     * @return mixed
     */
    function json5_decode(string $source, bool $associative = false, int $depth = 512, int $options = 0): mixed
    {
        return Json5Decoder::decode($source, $associative, $depth, $options);
    }
}
