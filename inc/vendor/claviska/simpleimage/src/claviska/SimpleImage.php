...
class SimpleImage
{
   ...
   */
  public static function darkenColor(array|string $color, int $amount): array
  {
   ...
   * @return integer[] An RGBA color array.
   */
  public static function adjustColor(array|string $color, int $red, int $green, int $blue, int $alpha): array
  {
    // Normalize to RGBA
    try {
   ...
   */
  #[ArrayShape(['red' => "int", 'green' => "int", 'blue' => "int", 'alpha' => "float|int"])] public static function normalizeColor(array|string $color): array
  {
   ...
   *
   * @param float|integer $value A numeric value to test.
   * @param float|integer $min The minimum allowed value.
   * @param float|integer $max The maximum allowed value.
   * @return integer|float
   */
  protected static function keepWithin(float|int $value, float|int $min, float|int $max): float|int
  {
   ...
   * @return integer[] An RGBA color array.
   */
  public static function lightenColor(array|string $color, int $amount): array
  {
    return self::adjustColor($color, $amount, $amount, $amount, 0);
  }
   ...
   *
   * @param null $mimeType The image format to output as a mime type (defaults to the original mime type).
   * @param integer $quality Image quality as a percentage (default 100).
   * @return string Returns a string containing a data URI.
   */
  public function toDataUri($mimeType = null, int $quality = 100): string
  {
    try {
   ...
   */
  #[ArrayShape(['data' => "false|string", 'mimeType' => "string"])] protected function generate(string $mimeType = null, int $quality = 100): array
  {
   ...
   * @return SimpleImage
   */
  public function toDownload(string $filename, $mimeType = null, int $quality = 100): static
  {
    try {
      $image = $this->generate($mimeType, $quality);
    } catch (Exception $e) {
   ...
   */
  public function toFile(string $file, string $mimeType = null, int $quality = 100): static
  {
    $image = $this->generate($mimeType, $quality);
   ...
   * @return SimpleImage
   */
  public function toScreen($mimeType = null, int $quality = 100): static
  {
    try {
      $image = $this->generate($mimeType, $quality);
    } catch (Exception $e) {
   ...
   * @return string
   */
  public function toString($mimeType = null, int $quality = 100): \false|string|string
  {
    try {
   ...
   * @return SimpleImage
   */
  public function rotate(int $angle, array|string $backgroundColor = 'transparent'): static
  {
   ...
   * @return integer
   */
  protected function allocateColor(array|string $color): int
  {
    try {
      $color = self::normalizeColor($color);
    } catch (Exception $e) {
   ...
   * @return SimpleImage
   */
  public function bestFit(int $maxWidth, int $maxHeight): SimpleImage|static
  {
   ...
   *
   * @param integer|null $width The new image width.
   * @param integer|null $height The new image height.
   * @return SimpleImage
   */
   ...
   * @return SimpleImage
   */
  function duotone(array|string $lightColor, array|string $darkColor): static
  {
    try {
   ...
   * @return false An RGBA color array or false if the x/y position is off the canvas.
   */
  #[Pure] public function getColorAt(int $x, int $y): bool
  {
   ...
   * @return SimpleImage
   */
  public function dot(int $x, int $y, array|string $color): static
  {
   ...
   */
  public function fitToHeight(int $height): SimpleImage|static
  {
   ...
   *    Please use `resize(null, $height)` instead.
   */
  public function fitToWidth(int $width): SimpleImage|static
  {
   ...
   * @param integer|null $res_y The vertical resolution in DPI
   * @return SimpleImage
   */
   ...
   * @return SimpleImage
   */
  public function fromNew(int $width, int $height, array|string $color = 'transparent'): static
  {
   ...
   * @return SimpleImage
   */
  public function fill(array|string $color): static
  {
   ...
   * @return SimpleImage
   */
  public function rectangle(int $x1, int $y1, int $x2, int $y2, array|string $color, int|array $thickness = 1): static
  {
    // Allocate the color
    $color = $this->allocateColor($color);
   ...
   * @param int $opacity The opacity level of the overlay 0-1 (default 1).
   ...
   * @return SimpleImage
   */
  public function overlay(string|SimpleImage $overlay, string $anchor = 'center', int $opacity = 1, int $xOffset = 0, int $yOffset = 0, bool $calculateOffsetFromEdge = false): static
  {
    // Load overlay image
    if (!($overlay instanceof SimpleImage)) try {
   ...
   * @return SimpleImage
   */
  public function thumbnail(int $width, int $height, string $anchor = 'center'): static
  {
   ...
   * Crop the image.
   *
   * @param float|integer $x1 Top left x coordinate.
   * @param float|integer $y1 Top left y coordinate.
   * @param float|integer $x2 Bottom right x coordinate.
   * @param float|integer $y2 Bottom right x coordinate.
   * @return SimpleImage
   */
  public function crop(float|int $x1, float|int $y1, float|int $x2, float|int $y2): static
  {
   ...
   * @return SimpleImage
   */
  public function border(array|string $color, int $thickness = 1): static
  {
    $x1 = -1;
    $y1 = 0;
    $x2 = $this->getWidth();
   ...
   * @param int $thickness Line thickness in pixels or 'filled' (default 1).
   * @return SimpleImage
   */
  public function ellipse(int $x, int $y, int $width, int $height, array|string $color, int $thickness = 1): static
  {
    // Allocate the color
   ...
   */
  private function excludeInsideColor($x, $y, array|string $borderColor): void
  {
   ...
   * @return SimpleImage
   */
  public function line(int $x1, int $y1, int $x2, int $y2, array|string $color, int $thickness = 1): static
  {
    // Allocate the color
    $color = $this->allocateColor($color);
   ...
   * @return SimpleImage
   */
  public function polygon(array $vertices, array|string $color, int|array $thickness = 1): static
  {
    // Allocate the color
    $color = $this->allocateColor($color);
   ...
   * @return SimpleImage
   */
  public function roundedRectangle(int $x1, int $y1, int $x2, int $y2, int $radius, array|string $color, int $thickness = 1): static
  {
    if ($thickness === 'filled') {
   ...
   * @return SimpleImage
   */
  public function arc(int $x, int $y, int $width, int $height, int $start, int $end, array|string $color, int $thickness = 1): static
  {
    // Allocate the color
    $tempColor = $this->allocateColor($color);
    imagesetthickness($this->image, 1);
   ...
   * @return SimpleImage
   */
  public function colorize(array|string $color): static
  {
    try {
      $color = self::normalizeColor($color);
    } catch (Exception $e) {
   ...
   * @param array|string|null $backgroundColor
   ...
   */
  public function extractColors(int $count = 5, array|string $backgroundColor = null): array
  {
