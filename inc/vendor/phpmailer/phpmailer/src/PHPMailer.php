...
class PHPMailer
{
     ...
     * @return string
     */
    public static function getLE(): string
    {
        return static::$LE;
    }
     ...
     * @param string $le
     */
    protected static function setLE(string $le)
    {
        static::$LE = $le;
    }
     ...
     * @return bool
     */
    protected static function fileIsAccessible(string $path): bool
    {
     ...
     * @return bool
     */
    protected static function isPermittedPath(string $path): bool
    {
     ...
     */
    protected function edebug(string $str)
    {
        if ($this->SMTPDebug <= 0) {
            return;
        }
     ...
     * @param callable|string|null $patternselect Which pattern to use
     *
     * @return bool
     */
    public static function validateAddress(string $address, callable|string $patternselect = null): bool
    {
     ...
     * @return string
     */
    #[Pure] public function getMailMIME(): string
    {
        $result = '';
        $ismultipart = true;
        switch ($this->message_type) {
     ...
     * @return string
     */
    public function headerLine(string $name, int|string $value): string
    {
     ...
     *
     * @param string $text
     * @param string|null $breaktype What kind of line break to use; defaults to static::$LE
     *
     * @return string
     */
     ...
     * @return bool
     */
    public static function hasLineLongerThanMax(string $str): bool
    {
     ...
     * @return string
     */
    #[Pure] protected function getBoundary(string $boundary, string $charSet, string $contentType, string $encoding): string
    {
        $result = '';
        if ('' === $charSet) {
     ...
     * @see RFC822 3.4.1
     */
    public static function quotedString(string $str): string
    {
        if (preg_match('/[ ()<>@,;:"\/\[\]?=]/', $str)) {
     ...
     *
     * @param string $str multi-byte text to wrap encode
     * @param string|null $linebreak string to use as linefeed/end-of-line
     *
     * @return string
     */
    public function base64EncodeWrapMB(string $str, string $linebreak = null): string
    {
     ...
     * @return array
     */
    public static function parseAddresses(string $addrstr, bool $useimap = true, string $charset = self::CHARSET_ISO88591): array
    {
        $addresses = [];
     ...
     * @param array $extra
     */
    protected function doCallback(bool $isSent, array $to, array $cc, array $bcc, string $subject, string $body, string $from, array $extra)
    {
     ...
     *
     * @param array|null $options An array of options compatible with stream_context_create()
     *
     * @return bool
     * @throws Exception
     *
     ...
     * @return string
     */
    private function getSmtpErrorMessage(): string
    {
     ...
     * @return bool
     */
    private function mailPassthru(string $to, string $subject, string $body, string $header, ?string $params): bool
    {
     ...
     *
     */
    #[Pure] public function getSentMIMEMessage(): string
    {
     ...
     * @param int|string|null $options Either a PATHINFO_* constant,
     *                            or a string name to return only the specified piece
     *
     * @return string|array
     */
    public static function mb_pathinfo(string $path, int|string $options = null): array|string
    {
     ...
     * @return bool
     */
    protected function validateEncoding(string $encoding): bool
    {
        return in_array(
            $encoding,
            [
     ...
     */
    public function clearQueuedAddresses(string $kind)
    {
     ...
     * @param callable|bool $advanced Whether to use the internal HTML to text converter
     ...
     */
    public function msgHTML(string $message, string $basedir = '', callable|bool $advanced = false): string
    {
     ...
     * @param callable|bool $advanced Any boolean value to use the internal converter,
     *                                or provide your own callable for custom conversion.
     *                                *Never* pass user-supplied data into this parameter
     *
     * @return string
     */
    public function html2text(string $html, callable|bool $advanced = false): string
    {
     ...
     * @param mixed|string $value The value to set the property to
     *
     * @return bool
     */
    public function set(string $name, mixed|string $value = ''): bool
    {
     ...
     */
    public function sign(string $cert_filename, string $key_filename, string $key_pass, string $extracerts_filename = '')
    {
     ...
     */
    public function getOAuth(): OAuthTokenProvider
    {
        return $this->oauth;
    }
     ...
     *
     */
    protected function addAnAddress(string $kind, string $address, string $name = ''): bool
    {
