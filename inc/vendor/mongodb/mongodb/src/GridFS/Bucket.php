...
class Bucket
{
     ...
     * @return array
     */
    #[ArrayShape(['bucketName' => "string", 'databaseName' => "string", 'manager' => "\MongoDB\Driver\Manager", 'chunkSizeBytes' => "int", 'readConcern' => "\MongoDB\Driver\ReadConcern", 'readPreference' => "\MongoDB\Driver\ReadPreference", 'typeMap' => "array|string[]", 'writeConcern' => "\MongoDB\Driver\WriteConcern"])] public function __debugInfo()
    {
        return [
