...
final class Context
{
    ...
    #[Pure] public function __construct(Client $internalClient, string $uri)
    {
    ...
    /** @param array|string $readPreferenceTags */
    private function convertReadPreferenceTags(array|string $readPreferenceTags): array
    {
        return array_map(
