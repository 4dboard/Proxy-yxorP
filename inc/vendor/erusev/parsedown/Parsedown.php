...
class Parsedown
{
    ...
    function setBreaksEnabled($breaksEnabled): static
    {
    ...
    function setMarkupEscaped($markupEscaped): static
    {
    ...
    function setUrlsLinked($urlsLinked): static
    {
    ...
    function setSafeMode($safeMode): static
    {
    ...
    #[ArrayShape(['element' => "array"])] protected function paragraph($Line): array
    {
        return array(
            'element' => array(
                'name' => 'p',
    ...
    #[ArrayShape(['char' => "mixed", 'element' => "array"])] protected function blockFencedCode($Line)
    {
    ...
    #[ArrayShape(['indent' => "mixed", 'pattern' => "string", 'element' => "string[]", 'li' => "array"])] protected function blockList($Line)
    {
    ...
    #[ArrayShape(['hidden' => "bool"])] protected function blockReference($Line)
    {
    ...
    #[ArrayShape(['element' => "array"])] protected function blockQuote($Line)
    {
    ...
    #[ArrayShape(['element' => "string[]"])] protected function blockRule($Line)
    {
    ...
    #[ArrayShape(['extent' => "int", 'element' => "array"])] protected function inlineCode($Excerpt)
    {
    ...
    #[ArrayShape(['extent' => "int", 'element' => "array"])] protected function inlineEmailTag($Excerpt)
    {
    ...
    #[ArrayShape(['markup' => "mixed", 'extent' => "int"])] protected function inlineEscapeSequence($Excerpt)
    {
    ...
    #[ArrayShape(['markup' => "string", 'extent' => "int"])] protected function inlineSpecialCharacter($Excerpt)
    {
    ...
    #[ArrayShape(['extent' => "int", 'element' => "array"])] protected function inlineUrlTag($Excerpt)
    {
