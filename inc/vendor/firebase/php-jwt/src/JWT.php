...
class JWT
{
     ...
     */
    public static function decode(string $jwt, mixed $keyOrKeyArray, array $allowed_algs = array()): object
    {
     ...
     *
     */
    private static function getKeyMaterialAndAlgorithm(mixed $keyOrKeyArray, string $kid = null): array
    {
        if (
