...
if (!function_exists('fdiv')) {
    #[Pure] function fdiv(float $num1, float $num2): float
    {
        return p\Php80::fdiv($num1, $num2);
    }
}
if (!function_exists('preg_last_error_msg')) {
    #[Pure] function preg_last_error_msg(): string
    {
        return p\Php80::preg_last_error_msg();
    }
}
if (!function_exists('str_contains')) {
    #[Pure] function str_contains(?string $haystack, ?string $needle): bool
    {
        return p\Php80::str_contains($haystack ?? '', $needle ?? '');
    }
}
if (!function_exists('str_starts_with')) {
    #[Pure] function str_starts_with(?string $haystack, ?string $needle): bool
    {
        return p\Php80::str_starts_with($haystack ?? '', $needle ?? '');
    }
}
if (!function_exists('str_ends_with')) {
    #[Pure] function str_ends_with(?string $haystack, ?string $needle): bool
    {
