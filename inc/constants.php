...
class constants
{
    ...
    public static function localise($_req)
    {
        ...
        $YXORP_TARGET_DOMAIN = constants::get(YXORP_TARGET_DOMAIN);
        print_r($YXORP_TARGET_DOMAIN);

        constants::set(YXORP_FETCH, VAR_HTTPS . CHAR_SLASH . CHAR_SLASH . ((!is_null(constants::get(YXORP_SITE_SUB_DOMAIN))) ? (constants::get(YXORP_SITE_SUB_DOMAIN) . ".") : null) . constants::get(YXORP_TARGET_DOMAIN));
