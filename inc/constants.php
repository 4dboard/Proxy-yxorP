...
class constants
{
    ...
    public static function create($_dir): void
    {
        ...
        self::set(YXORP_GUZZLE\Client, new Guzzle([VAR_ALLOW_REDIRECTS => true, VAR_HTTP_ERRORS => true, VAR_DECODE_CONTENT => true, VAR_VERIFY => false, VAR_COOKIES => true, VAR_IDN_CONVERSION => true]));
