...
define('PATH_DIR_CACHE', __DIR__ . DIRECTORY_SEPARATOR . DIR_CACHE . CACHE_KEY . FILE_CACHE);
...
class constants
{
    ...
    public static function create(string $yxorp_root): void
    {
        ...
        define('PATH_REWRITE_REPLACE', DIR_ROOT . DIR_INC . DIR_DATA . FILE_REWRITE_REPLACE);
