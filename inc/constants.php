...
class constants
{
    ...
    public static function create($_dir): void
    {
        ...
        define('YXORP_COCKPIT_APP', YXORP_COCKPIT . CHAR_UNDER . YXORP_APP);
        ...
        define('REG_ONE', DIRECTORY_SEPARATOR . CHAR_SLASH . CHAR_QUESTION . CHAR_PERIOD . CHAR_ASTRIX . DIRECTORY_SEPARATOR);
