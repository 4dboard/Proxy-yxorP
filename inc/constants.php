...
class constants
{
    ...
    public static function create(string $dir): void
    {
        ...
        creates them. */
        foreach (array(DIR_PROXY, DIR_PSR, DIR_SNAG, DIR_HTTP, DIR_MINIFY, DIR_PARSER) as $_asset) generalHelper::fileCheck(DIR_ROOT . $_asset, true);

        // Reporting
        /* Setting the token to the snag key. */
        self::set(VAR_SNAG, \yxorP\snag\Client::make(ENV_BUG_SNAG_KEY));
        /* Setting the token PROXY to a new instance of the ProxyHttp\Client class. */
