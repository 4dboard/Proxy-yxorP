...
use yxorP\inc\snag\Breadcrumbs\Breadcrumb;
use yxorP\inc\snag\Breadcrumbs\Recorder;
use yxorP\inc\snag\Callbacks\GlobalMetaData;
use yxorP\inc\snag\Callbacks\RequestContext;
use yxorP\inc\snag\Callbacks\RequestMetaData;
use yxorP\inc\snag\Callbacks\RequestSession;
use yxorP\inc\snag\Callbacks\RequestUser;
use yxorP\inc\snag\Internal\proxyCompat;
use yxorP\inc\snag\Middleware\BreadcrumbData;
use yxorP\inc\snag\Middleware\CallbackBridge;
use yxorP\inc\snag\Middleware\DiscardClasses;
use yxorP\inc\snag\Middleware\NotificationSkipper;
use yxorP\inc\snag\Middleware\SessionData;
use yxorP\inc\snag\Request\BasicResolver;
use yxorP\inc\snag\Request\ResolverInterface;
use yxorP\inc\snag\Shutdown\PhpShutdownStrategy;
use yxorP\inc\snag\Shutdown\ShutdownStrategyInterface;
...
class Client
{
    ...
    protected BasicResolver|ResolverInterface $resolver;
    ...
    public static function makeproxy($base = null, array $options = []): \yxorP\inc\proxy\Client
    {
    ...
    public function getSessionClient(): \yxorP\inc\proxy\Client
    {
