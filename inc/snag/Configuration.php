...
class Configuration
{
    ...
    protected bool $batchSending = true;
    protected $notifyReleaseStages;
    protected array $filters = ['password', 'cookie', 'authorization', 'php-auth-user', 'php-auth-pw', 'php-auth-digest',];
    protected $projectRootRegex;
    protected $stripPathRegex;
    protected bool $sendCode = true;
    protected array $notifier = ['name' => 'Snag PHP (Official)', 'version' => '3.27.0', 'url' => 'https://bugsnag.com',];
    protected string|false $fallbackType;
    protected array $appData = [];
    protected array $deviceData = [];
    protected array $metaData = [];
    protected $errorReportingLevel;
    protected bool $autoCaptureSessions = false;
    protected \yxorP\inc\proxy\Client $sessionClient;
    protected string $notifyEndpoint = self::NOTIFY_ENDPOINT;
    protected string $sessionEndpoint = self::SESSION_ENDPOINT;
    protected string $buildEndpoint = self::BUILD_ENDPOINT;
    protected int $memoryLimitIncrease = 5242880;
    protected array $discardClasses = [];
