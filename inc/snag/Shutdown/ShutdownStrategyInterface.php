 ...
 *
 * The yxorP\inc\snag\Client has a "batch sending" mode that defers any flush() calls until after the user's code has
 * completed executing. It originally accomplished this via a hardcoded call to register_shutdown_function() in the
 * Client constructor. This has now been replaced by this interface. The yxorP\inc\snag\Client now delegates the shutdown
