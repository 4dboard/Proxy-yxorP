...
class Report
{
    ...
    protected bool $unhandled = false;
    protected array $severityReason = [];
    protected $session;
    ...
    #[ArrayShape(['errorClass' => "", 'errorMessage' => "", 'type' => "string"])] #[ArrayShape(['errorClass' => "", 'errorMessage' => "", 'type' => "string"])] private function toError(): array
    {
    ...
    #[ArrayShape(['errorClass' => "", 'message' => "", 'stacktrace' => "mixed"])] #[ArrayShape(['errorClass' => "", 'message' => "", 'stacktrace' => "mixed"])] protected function exceptionObject(): array
    {
