...
class proxyClientAction extends wrapper
{
    ...
    public function onSend(): void
    {
        ...
        var_drump(constants::get(VAR_PROXY)->request(constants::get(VAR_REQUEST)->getMethod(), constants::get(VAR_REQUEST)->getUrl(), json_decode(json_encode($_REQUEST), true, 512, JSON_THROW_ON_ERROR))->getBody());
