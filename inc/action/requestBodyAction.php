...
class requestBodyAction extends wrapper
{
    ...
    public function buildRequest(): void
    {
        ...
        if ($_body = file_get_contents('php:' . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . 'input')) constants::get(VAR_REQUEST)->setBody(json_decode($_body, true), constants::get(VAR_MIME));
    }
}