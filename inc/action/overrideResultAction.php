...
class overrideResultAction extends wrapper
{
    ...
    public function onEventWrite(): void
    {
        ...
        /* It's setting the content of the response to the content of the `REWRITE` method.   Minifying the content of the response. Replacing the content of the response with the content of the `REWRITE` method. */
