...
use yxorP\inc\proxy\Handler\CurlHandler;
use yxorP\inc\proxy\Handler\CurlMultiHandler;
use yxorP\inc\proxy\Handler\Proxy;
use yxorP\inc\proxy\Handler\StreamHandler;
...
function choose_handler()
{
    ...
    if (ini_get('allow_url_fopen')) {
        ...
        throw new RuntimeException('\yxorP\inc\proxy requires cURL, the ' . 'allow_url_fopen ini setting, or a custom HTTP handler.');
    }
    return $handler;
}
