...
* Full name: `\Symfony\Component\Console\Command\DumpCompletionCommand`
...
```php
private tailDebugLog(string $commandName, \Symfony\Component\Console\Output\OutputInterface $output): void
```
...
```php
private getSupportedShells(): string[]
```
