...
* Full name: `\Symfony\Component\Validator\Constraints\ExpressionValidator`
...
```php
public __construct(\Symfony\Component\PropertyAccess\PropertyAccessorInterface $propertyAccessor = null, \Symfony\Component\ExpressionLanguage\ExpressionLanguage $expressionLanguage = null): mixed
```
...
```php
private getExpressionLanguage(): mixed
```
...
```php
private getPropertyAccessor(): mixed
```
