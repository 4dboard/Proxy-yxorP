...
* Full name: `\Symfony\Component\Validator\Constraints\DateTimeValidator`
* Parent class: [`\Symfony\Component\Validator\Constraints\DateValidator`](./DateValidator.md)
...
|:---------|:-----------|:-----|:------|
|`PATTERN`|public| |&#039;/^(\\d{4})-(\\d{2})-(\\d{2}) (\\d{2}):(\\d{2}):(\\d{2})$/&#039;|
