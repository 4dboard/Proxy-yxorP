...
* Full name: `\Symfony\Component\Validator\Constraints\IsbnValidator`
...
```php
protected validateIsbn10(mixed $isbn): mixed
```
...
```php
protected validateIsbn13(mixed $isbn): mixed
```
...
```php
protected getMessage(mixed $constraint, mixed $type = null): mixed
```
