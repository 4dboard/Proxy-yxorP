...
* Full name: `\Symfony\Component\Validator\Constraints\CallbackValidator`
...
```php
public validate(mixed $object, \Symfony\Component\Validator\Constraint $constraint): mixed
```
