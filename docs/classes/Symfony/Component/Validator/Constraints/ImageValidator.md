...
Validates whether a value is a valid image file and is valid against minWidth, maxWidth, minHeight and maxHeight
constraints.

* Full name: `\Symfony\Component\Validator\Constraints\ImageValidator`
* Parent class: [`\Symfony\Component\Validator\Constraints\FileValidator`](./FileValidator.md)
