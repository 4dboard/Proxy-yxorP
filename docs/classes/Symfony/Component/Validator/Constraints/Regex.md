...
* Full name: `\Symfony\Component\Validator\Constraints\Regex`
...
|:---------|:-----------|:-----|:------|
|`REGEX_FAILED_ERROR`|public| |&#039;de1e3db3-5ed4-4941-aae4-59f3667cc3a3&#039;|
...
```php
public getHtmlPattern(): string|null
```

Example: /^[a-z]+$/ would be converted to [a-z]+ However, if options are specified, it cannot be converted.
