...
* Full name: `\Symfony\Component\Validator\Tests\Constraints\CurrencyValidatorTest`
* Parent
...
```php
public testValidCurrencies(mixed $currency): mixed
```
...
### testValidCurrenciesWithCountrySpecificLocale

```php
public testValidCurrenciesWithCountrySpecificLocale(mixed $currency): mixed
```
...
```php
public getValidCurrencies(): mixed
```

***

### testInvalidCurrencies

```php
public testInvalidCurrencies(mixed $currency): mixed
```
...
### getInvalidCurrencies

```php
public getInvalidCurrencies(): mixed
```
