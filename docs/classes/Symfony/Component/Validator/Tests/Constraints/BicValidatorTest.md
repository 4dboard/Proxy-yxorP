...
* Full name: `\Symfony\Component\Validator\Tests\Constraints\BicValidatorTest`
* Parent
...
```php
public testValidBics(mixed $bic): mixed
```
...
```php
public testInvalidBics(mixed $bic, mixed $code): mixed
```
