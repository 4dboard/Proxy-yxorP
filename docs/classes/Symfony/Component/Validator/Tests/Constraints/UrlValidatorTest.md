...
* Full name: `\Symfony\Component\Validator\Tests\Constraints\UrlValidatorTest`
* Parent
...
### testEmptyStringFromObjectIsValid

```php
public testEmptyStringFromObjectIsValid(): mixed
```
...
```php
public testValidUrls(mixed $url): mixed
```
...
```php
public testInvalidUrls(mixed $url): mixed
```
...
```php
public getInvalidUrls(): mixed
```

***

### testCustomProtocolIsValid

```php
public testCustomProtocolIsValid(mixed $url): mixed
```
...
```php
public getValidCustomUrls(): mixed
```
...
```php
public testCheckDns(mixed $violation): mixed
```
