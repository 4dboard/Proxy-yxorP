...
* Full name: `\Symfony\Component\Validator\Tests\Constraints\TypeValidatorTest`
* Parent
...
### testEmptyIsValidIfString

```php
public testEmptyIsValidIfString(): mixed
```

***

### testEmptyIsInvalidIfNoString

```php
public testEmptyIsInvalidIfNoString(): mixed
```
...
```php
public testValidValues(mixed $value, mixed $type): mixed
```
...
```php
public testInvalidValues(mixed $value, mixed $type, mixed $valueAsString): mixed
```
