...
* Full name: `\Symfony\Component\Validator\Tests\Constraints\CountryValidatorTest`
...
```php
public testValidCountries(mixed $country): mixed
```
...
```php
public getValidCountries(): mixed
```
...
### testInvalidCountries



```php
public testInvalidCountries(mixed $country): mixed
```
...
```php
public getInvalidCountries(): mixed
```
