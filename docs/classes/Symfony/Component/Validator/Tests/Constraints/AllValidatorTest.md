...
* Full name: `\Symfony\Component\Validator\Tests\Constraints\AllValidatorTest`
...
```php
public testWalkSingleConstraint(mixed $array): mixed
```
...
```php
public testWalkMultipleConstraints(mixed $array): mixed
```
...
```php
public getValidArguments(): mixed
```
