...
* Full name: `\Symfony\Component\Validator\Tests\Constraints\BlankValidatorTest`
...
```php
public testInvalidValues(mixed $value, mixed $valueAsString): mixed
```
