...
* Full name: `\Symfony\Component\Config\Definition\Builder\ScalarNodeDefinition`
* Parent class: [`\Symfony\Component\Config\Definition\Builder\VariableNodeDefinition`](./VariableNodeDefinition.md)
...
```php
protected instantiateNode(): \Symfony\Component\Config\Definition\ScalarNode
```
