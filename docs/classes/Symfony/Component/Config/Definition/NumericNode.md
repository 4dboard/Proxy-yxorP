...
* Full name: `\Symfony\Component\Config\Definition\NumericNode`
...
```php
public __construct(mixed $name, \Symfony\Component\Config\Definition\NodeInterface $parent = null, mixed $min = null, mixed $max = null): mixed
```
...
|-----------|------|-------------|
| `$name` | **mixed** |  |
| `$parent` | **\Symfony\Component\Config\Definition\NodeInterface** |  |
| `$min` | **mixed** |  |
| `$max` | **mixed** |  |
