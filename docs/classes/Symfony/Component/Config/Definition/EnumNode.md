...
* Full name: `\Symfony\Component\Config\Definition\EnumNode`
...
```php
public __construct(mixed $name, \Symfony\Component\Config\Definition\NodeInterface $parent = null, array $values = array()): mixed
```
