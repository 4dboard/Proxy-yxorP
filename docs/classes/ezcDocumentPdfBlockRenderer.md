...
# ezcDocumentPdfBlockRenderer

General block renderer.

Implements the methods to render the border for block level elements, like list items. Also applies margin and padding
to the rendered item. For custom rendering implementations inside of the rendered block you may overwrite the process()
method.

* Full name: `\ezcDocumentPdfBlockRenderer`
