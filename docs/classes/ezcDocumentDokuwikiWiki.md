...
Dokuwiki is a popular wiki system, for example used on wiki.php.net with a quite different syntax, and the most complete
markup support, even including something like footnotes. The markup is documented at:
