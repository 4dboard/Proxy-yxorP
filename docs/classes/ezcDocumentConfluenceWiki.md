...
Confluence is the wiki syntax used in the Atlassian wiki project Confluence. Its syntax differs quite a lot from other
common wiki markup syntaxes. The markup language is documented at:
