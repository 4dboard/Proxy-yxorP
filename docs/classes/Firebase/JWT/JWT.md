...
| `$jwt` | **string** | The JWT |
| `$key` | **
string&#124;array&#124;resource** | The key, or map of keys.<br />If the algorithm used is asymmetric, this is the public key |
| `$allowed_algs` | **
array** | List of supported verification algorithms<br />Supported algorithms are &#039;ES384&#039;,&#039;ES256&#039;, &#039;HS256&#039;, &#039;HS384&#039;,<br />&#039;HS512&#039;, &#039;RS256&#039;, &#039;RS384&#039;, and &#039;RS512&#039; |
...
[$offset, $data] the new offset and the decoded object yxorP::get('REQUEST')
