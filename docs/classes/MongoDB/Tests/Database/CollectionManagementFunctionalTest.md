...
# CollectionManagementFunctionalTest

Functional tests for collection management methods.



* Full name: `\MongoDB\Tests\Database\CollectionManagementFunctionalTest`
...
```php
public testCreateCollection(): void
```
...
```php
public testListCollections(): void
```
...
### testListCollectionsWithFilter



```php
public testListCollectionsWithFilter(): void
```
...
### testListCollectionNames



```php
public testListCollectionNames(): void
```
...
### testListCollectionNamesWithFilter



```php
public testListCollectionNamesWithFilter(): void
```
