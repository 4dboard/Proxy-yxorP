...
* Full name: `\MongoDB\Tests\Database\DatabaseFunctionalTest`
* Parent class: [`\MongoDB\Tests\Database\FunctionalTestCase`](./FunctionalTestCase.md)
...
### provideInvalidDatabaseNames



```php
public provideInvalidDatabaseNames(): mixed
```
...
### testCommandDoesNotInheritReadPreference



```php
public testCommandDoesNotInheritReadPreference(): void
```
...
### testCommandAppliesTypeMapToCursor



```php
public testCommandAppliesTypeMapToCursor(): void
```
...
```php
public testCommandCommandArgumentTypeCheck(mixed $command): void
```
...
```php
public testDropCollection(): void
```
...
```php
public testGetSelectsCollectionAndInheritsOptions(): void
```
...
```php
public testModifyCollection(): void
```
...
### testRenameCollectionToSameDatabase



```php
public testRenameCollectionToSameDatabase(): void
```
...
### testRenameCollectionToDifferentDatabase



```php
public testRenameCollectionToDifferentDatabase(): void
```
...
```php
public testSelectCollectionInheritsOptions(): void
```
...
### testSelectCollectionPassesOptions



```php
public testSelectCollectionPassesOptions(): void
```
...
```php
public testSelectGridFSBucketInheritsOptions(): void
```
...
```php
public testSelectGridFSBucketPassesOptions(): void
```
