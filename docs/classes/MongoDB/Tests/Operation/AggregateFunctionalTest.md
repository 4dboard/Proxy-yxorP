...
* Full name: `\MongoDB\Tests\Operation\AggregateFunctionalTest`
...
### testAllowDiskUseIsOmittedByDefault



```php
public testAllowDiskUseIsOmittedByDefault(): void
```
...
```php
public testBatchSizeIsIgnoredIfPipelineIncludesOutStage(): void
```
...
```php
public testCurrentOpCommand(): void
```
...
```php
public testEmptyPipelineReturnsAllDocuments(): void
```
...
```php
public testUnrecognizedPipelineState(): void
```
...
```php
public testTypeMapOption(?array $typeMap, array $expectedDocuments): void
```
...
### testExplainOptionWithWriteConcern



```php
public testExplainOptionWithWriteConcern(): void
```
...
### testReadPreferenceWithinTransaction



```php
public testReadPreferenceWithinTransaction(): void
```
