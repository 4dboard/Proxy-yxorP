...
# RenameCollectionFunctionalTest

Base class for Operation functional tests.



* Full name: `\MongoDB\Tests\Operation\RenameCollectionFunctionalTest`
...
```php
private static int $errorCodeNamespaceExists
```
...
### testRenameCollectionToNonexistentTarget



```php
public testRenameCollectionToNonexistentTarget(): void
```
...
### testRenameCollectionExistingTarget



```php
public testRenameCollectionExistingTarget(): void
```
...
### testRenameNonexistentCollection



```php
public testRenameNonexistentCollection(): void
```
