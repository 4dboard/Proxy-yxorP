...
# ModifyCollectionTest

Base class for Operation unit tests.



* Full name: `\MongoDB\Tests\Operation\ModifyCollectionTest`
...
### testConstructorEmptyCollectionOptions



```php
public testConstructorEmptyCollectionOptions(): void
```
