...
# ListCollectionNamesFunctionalTest

Base class for Operation functional tests.



* Full name: `\MongoDB\Tests\Operation\ListCollectionNamesFunctionalTest`
...
### testListCollectionNamesForNewlyCreatedDatabase



```php
public testListCollectionNamesForNewlyCreatedDatabase(): void
```
...
### testAuthorizedCollectionsOption



```php
public testAuthorizedCollectionsOption(): void
```
