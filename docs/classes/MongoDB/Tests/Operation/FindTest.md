...
* Full name: `\MongoDB\Tests\Operation\FindTest`
...
```php
public testSnapshotOptionIsDeprecated(): void
```
...
```php
public testMaxScanOptionIsDeprecated(): void
```
...
```php
public testConstructorCursorTypeOption(mixed $cursorType): void
```
...
```php
public provideInvalidConstructorCursorTypeOptions(): mixed
```
