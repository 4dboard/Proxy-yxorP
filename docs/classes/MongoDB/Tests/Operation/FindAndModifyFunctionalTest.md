...
* Full name: `\MongoDB\Tests\Operation\FindAndModifyFunctionalTest`
...
```php
public testManagerReadConcernIsOmitted(): void
```
...
* https://jira.mongodb.org/browse/PHPLIB-344 - 
...
### testHintOptionUnsupportedClientSideError



```php
public testHintOptionUnsupportedClientSideError(): void
```
