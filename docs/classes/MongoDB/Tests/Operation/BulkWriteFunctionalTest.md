...
* Full name: `\MongoDB\Tests\Operation\BulkWriteFunctionalTest`
...
```php
public testMixedOrderedOperations(): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesDeletedCount(\MongoDB\BulkWriteResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesInsertCount(\MongoDB\BulkWriteResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesMatchedCount(\MongoDB\BulkWriteResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesModifiedCount(\MongoDB\BulkWriteResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesUpsertedCount(\MongoDB\BulkWriteResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesUpsertedIds(\MongoDB\BulkWriteResult $result): void
```
...
```php
public testBulkWriteWithPipelineUpdates(): void
```
