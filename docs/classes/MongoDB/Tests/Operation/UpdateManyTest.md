...
* Full name: `\MongoDB\Tests\Operation\UpdateManyTest`
...
```php
public testConstructorUpdateArgument(mixed $update): void
```
...
```php
public testConstructorUpdateArgumentRequiresOperators(mixed $replacement): void
```
