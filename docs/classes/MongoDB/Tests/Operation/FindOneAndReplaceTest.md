...
* Full name: `\MongoDB\Tests\Operation\FindOneAndReplaceTest`
...
```php
public testConstructorReplacementArgumentRequiresNoOperators(): void
```
...
```php
public testConstructorReturnDocumentOption(mixed $returnDocument): void
```
...
```php
public provideInvalidConstructorReturnDocumentOptions(): mixed
```
