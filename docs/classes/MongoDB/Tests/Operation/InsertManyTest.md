...
* Full name: `\MongoDB\Tests\Operation\InsertManyTest`
...
```php
public testConstructorDocumentsMustNotBeEmpty(): void
```
...
```php
public testConstructorDocumentsMustBeAList(): void
```
...
```php
public testConstructorDocumentsArgumentElementTypeChecks(mixed $document): void
```
