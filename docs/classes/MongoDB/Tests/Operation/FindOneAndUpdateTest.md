...
* Full name: `\MongoDB\Tests\Operation\FindOneAndUpdateTest`
...
### testConstructorUpdateArgumentRequiresOperatorsOrPipeline



```php
public testConstructorUpdateArgumentRequiresOperatorsOrPipeline(): void
```
