...
* Full name: `\MongoDB\Tests\Operation\InsertManyFunctionalTest`
...
```php
public testUnacknowledgedWriteConcernAccessesInsertedCount(\MongoDB\InsertManyResult $result): void
```
...
|-----------|------|-------------|
| `$result` | **\MongoDB\InsertManyResult** |  |
...
```php
public testUnacknowledgedWriteConcernAccessesInsertedId(\MongoDB\InsertManyResult $result): void
```
