...
* Full name: `\MongoDB\Tests\Operation\UpdateFunctionalTest`
...
### testHintOptionAndUnacknowledgedWriteConcernUnsupportedClientSideError



```php
public testHintOptionAndUnacknowledgedWriteConcernUnsupportedClientSideError(): void
```
...
```php
public testUpdateManyWithExistingId(): void
```
...
```php
public testUpdateManyWithGeneratedId(): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesMatchedCount(\MongoDB\UpdateResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesModifiedCount(\MongoDB\UpdateResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesUpsertedCount(\MongoDB\UpdateResult $result): void
```
...
```php
public testUnacknowledgedWriteConcernAccessesUpsertedId(\MongoDB\UpdateResult $result): void
```
