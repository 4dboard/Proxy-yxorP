...
* Full name: `\MongoDB\Tests\Operation\DropIndexesFunctionalTest`
...
```php
public testDropOneIndexByName(): void
```
...
```php
public testDropAllIndexesByWildcard(): void
```
...
```php
public testDropByIndexInfo(): void
```
...
```php
private assertIndexExists(mixed $indexName, callable $callback = null): void
```
