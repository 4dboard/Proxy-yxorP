...
* Full name: `\MongoDB\Tests\Operation\ReplaceOneTest`
...
```php
public testConstructorReplacementArgumentTypeCheck(mixed $replacement): void
```
...
```php
public testConstructorReplacementArgument(mixed $replacement): void
```
...
```php
public testConstructorReplacementArgumentRequiresNoOperators(mixed $replacement): void
```
...
```php
public provideReplacementDocuments(): mixed
```
...
```php
public provideUpdateDocuments(): mixed
```
