...
* Full name: `\MongoDB\Tests\Operation\ListIndexesFunctionalTest`
...
```php
public testListIndexesForNewlyCreatedCollection(): void
```
...
```php
public testListIndexesForNonexistentCollection(): void
```
