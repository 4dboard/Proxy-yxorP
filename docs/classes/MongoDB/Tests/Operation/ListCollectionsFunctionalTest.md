...
* Full name: `\MongoDB\Tests\Operation\ListCollectionsFunctionalTest`
...
```php
public testListCollectionsForNewlyCreatedDatabase(): void
```
...
```php
public testIdIndexAndInfo(): void
```
...
```php
public testListCollectionsForNonexistentDatabase(): void
```
