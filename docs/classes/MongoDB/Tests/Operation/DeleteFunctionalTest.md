...
* Full name: `\MongoDB\Tests\Operation\DeleteFunctionalTest`
...
```php
public testUnacknowledgedWriteConcernAccessesDeletedCount(\MongoDB\DeleteResult $result): void
```
