...
Errors for bulkWrite and insertMany operations may still report a write result. This method will attempt to extract such
a result so that it can be used in executeAssertResult().
