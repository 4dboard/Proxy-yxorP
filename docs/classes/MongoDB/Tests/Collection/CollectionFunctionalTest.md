...
* Full name: `\MongoDB\Tests\Collection\CollectionFunctionalTest`
...
```php
public testConstructorDatabaseNameArgument(mixed $databaseName): void
```
...
```php
public testConstructorCollectionNameArgument(mixed $collectionName): void
```
...
```php
public provideInvalidDatabaseAndCollectionNames(): mixed
```
...
```php
public getGetCollectionName(): void
```
...
```php
public getGetDatabaseName(): void
```
...
```php
public testGetNamespace(): void
```

***

### testAggregateWithinTransaction

```php
public testAggregateWithinTransaction(): void
```
...
```php
public testCreateIndexSplitsCommandOptions(): void
```
...
```php
public testDistinctWithTypeMap(array $typeMap, array $expectedDocuments): void
```
...
```php
public testDropIndexShouldNotAllowWildcardCharacter(): void
```
...
### testFindWithinTransaction

```php
public testFindWithinTransaction(): void
```

***

### testRenameToSameDatabase

```php
public testRenameToSameDatabase(): void
```

***

### testRenameToDifferentDatabase

```php
public testRenameToDifferentDatabase(): void
```
...
```php
public testWithOptionsInheritsOptions(): void
```

***

### testWithOptionsPassesOptions

```php
public testWithOptionsPassesOptions(): void
```
...
```php
public collectionMethodClosures(): mixed
```
...
```php
public collectionReadMethodClosures(): mixed
```

***

### collectionWriteMethodClosures

```php
public collectionWriteMethodClosures(): mixed
```

***

### testMethodDoesNotInheritReadWriteConcernInTranasaction

```php
public testMethodDoesNotInheritReadWriteConcernInTranasaction(\Closure $method): void
```
...
```php
public testMethodInTransactionWithWriteConcernOption(mixed $method): void
```
...
```php
public testMethodInTransactionWithReadConcernOption(mixed $method): void
```
...
```php
private createFixtures(int $n, array $executeBulkWriteOptions = []): void
```
