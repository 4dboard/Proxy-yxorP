...
* Full name: `\MongoDB\Tests\ClientTest`
* Parent class: [`\MongoDB\Tests\TestCase`](./TestCase.md)

## Methods

### testConstructorDefaultUri

```php
public testConstructorDefaultUri(): void
```
...
```php
public testConstructorAutoEncryptionOpts(): void
```
...
```php
public testConstructorDriverOptionTypeChecks(array $driverOptions, string $exception = InvalidArgumentException::class): void
```
...
```php
public provideInvalidConstructorDriverOptions(): mixed
```
...
```php
public testGetSelectsDatabaseAndInheritsOptions(): void
```
...
```php
public testSelectDatabaseInheritsOptions(): void
```

***

### testSelectDatabasePassesOptions

```php
public testSelectDatabasePassesOptions(): void
```
...
```php
public testCreateClientEncryption(): void
```
...
```php
public testCreateClientEncryptionWithKeyVaultClient(): void
```
...
```php
public testCreateClientEncryptionWithManager(): void
```
...
```php
public testCreateClientEncryptionWithInvalidKeyVaultClient(): void
```
