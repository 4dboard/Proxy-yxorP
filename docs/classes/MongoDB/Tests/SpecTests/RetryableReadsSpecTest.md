...
* Full name: `\MongoDB\Tests\SpecTests\RetryableReadsSpecTest`
* Parent class: [`\MongoDB\Tests\SpecTests\FunctionalTestCase`](./FunctionalTestCase.md)

**See Also:**

* https://github.com/mongodb/specifications/tree/master/source/retryable-reads - 
...
```php
public testRetryableReads(\stdClass $test, array $runOn, array|object $data, string $databaseName, string|null $collectionName, string|null $bucketName): void
```
...
| `$data` | **array&#124;object** | Top-level &quot;data&quot; array to initialize collection |
| `$databaseName` | **string** | Name of database under test |
| `$collectionName` | **string&#124;null** | Name of collection under test |
| `$bucketName` | **string&#124;null** | Name of GridFS bucket under test |
