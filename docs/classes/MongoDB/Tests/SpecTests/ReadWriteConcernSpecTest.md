...
# ReadWriteConcernSpecTest

Base class for spec test runners.

* Full name: `\MongoDB\Tests\SpecTests\ReadWriteConcernSpecTest`
...
### testReadWriteConcern

Execute an individual test case from the specification.

```php
public testReadWriteConcern(\stdClass $test, array $runOn, array $data, string $databaseName = null, string $collectionName = null): void
```
