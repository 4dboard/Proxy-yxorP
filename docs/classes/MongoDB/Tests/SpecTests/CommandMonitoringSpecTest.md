...
* Full name: `\MongoDB\Tests\SpecTests\CommandMonitoringSpecTest`
...
```php
public testCommandMonitoring(\stdClass $test, array $data, string $databaseName = null, string $collectionName = null): void
```
...
Convert the server and topology requirements to a standard "runOn" array used by other specifications.
