...
# PrimaryStepDownSpecTest

Base class for spec test runners.



* Full name: `\MongoDB\Tests\SpecTests\PrimaryStepDownSpecTest`
* Parent class: [`\MongoDB\Tests\SpecTests\FunctionalTestCase`](./FunctionalTestCase.md)

**See Also:**

* https://github.com/mongodb/specifications/tree/master/source/connections-survive-step-down/tests - 
...
|:---------|:-----------|:-----|:------|
|`INTERRUPTED_AT_SHUTDOWN`|public| |11600|
|`NOT_PRIMARY`|public| |10107|
|`SHUTDOWN_IN_PROGRESS`|public| |91|
...
### testNotPrimaryKeepsConnectionPool



```php
public testNotPrimaryKeepsConnectionPool(): void
```
...
* https://github.com/mongodb/specifications/tree/master/source/connections-survive-step-down/tests#not-primary-keep-connection-pool - 

***

### testNotPrimaryResetConnectionPool



```php
public testNotPrimaryResetConnectionPool(): void
```
...
* https://github.com/mongodb/specifications/tree/master/source/connections-survive-step-down/tests#not-primary-reset-connection-pool - 

***

### testShutdownResetConnectionPool



```php
public testShutdownResetConnectionPool(): void
```
...
* https://github.com/mongodb/specifications/tree/master/source/connections-survive-step-down/tests#shutdown-in-progress-reset-connection-pool - 

***

### testInterruptedAtShutdownResetConnectionPool



```php
public testInterruptedAtShutdownResetConnectionPool(): void
```
...
* https://github.com/mongodb/specifications/tree/master/source/connections-survive-step-down/tests#interrupted-at-shutdown-reset-connection-pool - 

***

### testGetMoreIteration



```php
public testGetMoreIteration(): void
```
...
* https://github.com/mongodb/specifications/tree/master/source/connections-survive-step-down/tests#getmore-iteration - 
...
```php
private insertDocuments(mixed $count): mixed
```
...
```php
private dropAndRecreateCollection(): void
```
...
```php
private getTotalConnectionsCreated(?\MongoDB\Driver\Server $server = null): mixed
```
...
### waitForPrimaryReelection



```php
private waitForPrimaryReelection(): void
```
