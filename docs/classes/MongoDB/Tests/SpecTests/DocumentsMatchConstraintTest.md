...
* Full name: `\MongoDB\Tests\SpecTests\DocumentsMatchConstraintTest`
...
```php
public testIgnoreExtraKeysInRoot(): void
```
...
```php
public testIgnoreExtraKeysInEmbedded(): void
```
...
### testBSONTypeAssertions



```php
public testBSONTypeAssertions(mixed $type, mixed $value): void
```
...
```php
public testErrorMessages(mixed $expectedMessagePart, \MongoDB\Tests\SpecTests\DocumentsMatchConstraint $constraint, mixed $actualValue): void
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$expectedMessagePart` | **mixed** |  |
| `$constraint` | **\MongoDB\Tests\SpecTests\DocumentsMatchConstraint** |  |
| `$actualValue` | **mixed** |  |
...
```php
private assertResult(mixed $expectedResult, \MongoDB\Tests\SpecTests\DocumentsMatchConstraint $constraint, mixed $value, mixed $message): void
```
