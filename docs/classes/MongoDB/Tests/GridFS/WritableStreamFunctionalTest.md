...
* Full name: `\MongoDB\Tests\GridFS\WritableStreamFunctionalTest`
...
```php
public testWriteBytesAlwaysUpdatesFileSize(): void
```
...
### testWriteBytesCalculatesMD5



```php
public testWriteBytesCalculatesMD5(mixed $input, mixed $expectedMD5): void
```
...
```php
public provideInputDataAndExpectedMD5(): mixed
```
