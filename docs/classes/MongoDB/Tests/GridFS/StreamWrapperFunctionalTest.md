...
* Full name: `\MongoDB\Tests\GridFS\StreamWrapperFunctionalTest`
...
```php
public testReadableStreamClose(): void
```
...
```php
public testReadableStreamEof(): void
```
...
```php
public testReadableStreamRead(): void
```
...
```php
public testReadableStreamSeek(): void
```
...
```php
public testReadableStreamStat(): void
```
...
```php
public testReadableStreamWrite(): void
```
...
```php
public testWritableStreamClose(): void
```
...
```php
public testWritableStreamEof(): void
```
...
```php
public testWritableStreamRead(): void
```
...
```php
public testWritableStreamSeek(): void
```
...
### testWritableStreamStatBeforeSaving



```php
public testWritableStreamStatBeforeSaving(): void
```
...
```php
public testWritableStreamStatAfterSaving(): void
```
...
```php
public testWritableStreamWrite(): void
```
