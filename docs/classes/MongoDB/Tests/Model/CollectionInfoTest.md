...
* Full name: `\MongoDB\Tests\Model\CollectionInfoTest`
...
```php
public testGetBasicInformation(): void
```
...
```php
public testCappedCollectionMethods(): void
```
