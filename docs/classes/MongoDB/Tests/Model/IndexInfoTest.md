...
* Full name: `\MongoDB\Tests\Model\IndexInfoTest`
...
```php
public testImplementsArrayAccess(): void
```
...
```php
public testOffsetSetCannotBeCalled(): void
```
...
```php
public testOffsetUnsetCannotBeCalled(): void
```
