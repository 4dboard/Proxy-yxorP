...
# ChangeStreamIteratorTest

* Full name: `\MongoDB\Tests\Model\ChangeStreamIteratorTest`
...
### testFirstBatchArgumentTypeCheck

```php
public testFirstBatchArgumentTypeCheck(mixed $firstBatchSize): void
```
...
|-----------|------|-------------|
| `$firstBatchSize` | **mixed** |  |

***

### provideInvalidIntegerValues

```php
public provideInvalidIntegerValues(): mixed
```

***

### testInitialResumeToken

```php
public testInitialResumeToken(): void
```

***

### testInitialResumeTokenArgumentTypeCheck

```php
public testInitialResumeTokenArgumentTypeCheck(mixed $initialResumeToken): void
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$initialResumeToken` | **mixed** |  |

***

### testPostBatchResumeTokenArgumentTypeCheck

```php
public testPostBatchResumeTokenArgumentTypeCheck(mixed $postBatchResumeToken): void
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$postBatchResumeToken` | **mixed** |  |

***

### provideInvalidObjectValues

```php
public provideInvalidObjectValues(): mixed
```

***

### testPostBatchResumeTokenIsReturnedForLastElementInFirstBatch

```php
public testPostBatchResumeTokenIsReturnedForLastElementInFirstBatch(): void
```

***

### testRewindIsNopWhenFirstBatchIsEmpty

```php
public testRewindIsNopWhenFirstBatchIsEmpty(): void
```

***

### testRewindAdvancesWhenFirstBatchIsNotEmpty

```php
public testRewindAdvancesWhenFirstBatchIsNotEmpty(): void
```
