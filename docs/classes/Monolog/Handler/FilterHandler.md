...
|-----------|------|-------------|
| `$handler` | **
callable&#124;\Monolog\Handler\HandlerInterface** | Handler or factory callable($record&amp;#124;null, $filterHandler). |
...
|-----------|------|-------------|
| `$minLevelOrList` | **
int&#124;string&#124;array** | A list of levels to accept or a minimum level or level name if maxLevel is provided |
| `$maxLevel` | **
int&#124;string** | Maximum level or level name to accept, only used if $minLevelOrList is not an array |
