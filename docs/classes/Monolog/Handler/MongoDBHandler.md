...
$log = new Logger('application'); $mongodb = new MongoDBHandler(new \Mongo("mongodb://localhost:27017"), "logs", "prod")
; $log->pushHandler($mongodb);

* Full name: `\Monolog\Handler\MongoDBHandler`
...
```php
public __construct(mixed $mongo, mixed $database, mixed $collection, mixed $level = Logger::DEBUG, mixed $bubble = true): mixed
```
