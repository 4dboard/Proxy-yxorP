...
* Full name: `\Monolog\Handler\DoctrineCouchDBHandler`
...
```php
public __construct(\Doctrine\CouchDB\CouchDBClient $client, mixed $level = Logger::DEBUG, mixed $bubble = true): mixed
```
...
|-----------|------|-------------|
| `$client` | **\Doctrine\CouchDB\CouchDBClient** |  |
| `$level` | **mixed** |  |
| `$bubble` | **mixed** |  |
