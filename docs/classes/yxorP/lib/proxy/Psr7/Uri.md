...
```php
public static isDefaultPort(\yxorP\inc\Psr\Http\Message\UriInterface $uri): mixed
```
...
```php
public static isAbsolute(\yxorP\inc\Psr\Http\Message\UriInterface $uri): mixed
```
...
```php
public static isNetworkPathReference(\yxorP\inc\Psr\Http\Message\UriInterface $uri): mixed
```
...
```php
public static isAbsolutePathReference(\yxorP\inc\Psr\Http\Message\UriInterface $uri): mixed
```
...
```php
public static isRelativePathReference(\yxorP\inc\Psr\Http\Message\UriInterface $uri): mixed
```
...
```php
public static isSameDocumentReference(\yxorP\inc\Psr\Http\Message\UriInterface $uri, \yxorP\inc\Psr\Http\Message\UriInterface $base = null): mixed
```
...
```php
public static resolve(\yxorP\inc\Psr\Http\Message\UriInterface $base, mixed $rel): mixed
```
...
```php
public static withoutQueryValue(\yxorP\inc\Psr\Http\Message\UriInterface $uri, mixed $key): mixed
```
...
```php
private static getFilteredQueryString(\yxorP\inc\Psr\Http\Message\UriInterface $uri, array $keys): mixed
```
...
```php
public static withQueryValue(\yxorP\inc\Psr\Http\Message\UriInterface $uri, mixed $key, mixed $value): mixed
```
...
```php
public static withQueryValues(\yxorP\inc\Psr\Http\Message\UriInterface $uri, array $keyValueArray): mixed
```
