...
* Full name: `\GraphQL\Language\AST\InterfaceTypeExtensionNode`
...
```php
public \GraphQL\Language\AST\NodeList&lt;\GraphQL\Language\AST\InterfaceTypeDefinitionNode&gt; $interfaces
```
