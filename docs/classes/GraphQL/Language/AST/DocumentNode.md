...
* Full name: `\GraphQL\Language\AST\DocumentNode`
...
```php
public \GraphQL\Language\AST\NodeList&lt;\GraphQL\Language\AST\DefinitionNode&amp;\GraphQL\Language\AST\Node&gt; $definitions
```
