...
* Full name: `\GraphQL\Language\AST\SelectionSetNode`
...
```php
public \GraphQL\Language\AST\NodeList&lt;\GraphQL\Language\AST\SelectionNode&amp;\GraphQL\Language\AST\Node&gt; $selections
```
