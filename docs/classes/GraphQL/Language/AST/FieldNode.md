...
* Full name: `\GraphQL\Language\AST\FieldNode`
...
```php
public \GraphQL\Language\AST\NameNode|null $alias
```
...
```php
public \GraphQL\Language\AST\NodeList&lt;\GraphQL\Language\AST\ArgumentNode&gt; $arguments
```
...
```php
public \GraphQL\Language\AST\SelectionSetNode|null $selectionSet
```
