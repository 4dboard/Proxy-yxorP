...
* Full name: `\GraphQL\Language\AST\SchemaDefinitionNode`
...
```php
public \GraphQL\Language\AST\NodeList&lt;\GraphQL\Language\AST\OperationTypeDefinitionNode&gt; $operationTypes
```
