...
# ezcDocumentXhtmlEnumeratedElementFilter

Filter for XHtml enumerated lists.

Enumerated lists may have additional information about the list type they are numbered with (alpha, roman, ..), which is
kept by this method.

* Full name: `\ezcDocumentXhtmlEnumeratedElementFilter`
