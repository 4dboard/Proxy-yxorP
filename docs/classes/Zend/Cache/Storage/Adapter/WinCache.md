...
* Full name: `\Zend\Cache\Storage\Adapter\WinCache`
...
```php
public __construct(array|\Traversable|\Zend\Cache\Storage\Adapter\WinCacheOptions $options = null): mixed
```
...
|-----------|------|-------------|
| `$options` | **array&#124;\Traversable&#124;\Zend\Cache\Storage\Adapter\WinCacheOptions** |  |
...
```php
public setOptions(array|\Traversable|\Zend\Cache\Storage\Adapter\WinCacheOptions $options): \Zend\Cache\Storage\Adapter\WinCache
```
...
```php
public getOptions(): \Zend\Cache\Storage\Adapter\WinCacheOptions
```
