...
* Full name: `\Zend\Cache\Storage\Adapter\Memcache`
* Parent class: [`\Zend\Cache\Storage\Adapter\AbstractAdapter`](./AbstractAdapter.md)
* This class implements:
[`\Zend\Cache\Storage\AvailableSpaceCapableInterface`](../AvailableSpaceCapableInterface.md), [`\Zend\Cache\Storage\FlushableInterface`](../FlushableInterface.md), [`\Zend\Cache\Storage\TotalSpaceCapableInterface`](../TotalSpaceCapableInterface.md)
...
```php
public __construct(null|array|\Traversable|\Zend\Cache\Storage\Adapter\MemcacheOptions $options = null): mixed
```
...
|-----------|------|-------------|
| `$options` | **null&#124;array&#124;\Traversable&#124;\Zend\Cache\Storage\Adapter\MemcacheOptions** |  |
...
```php
protected getMemcacheResource(): \Memcache
```
...
```php
public setOptions(array|\Traversable|\Zend\Cache\Storage\Adapter\MemcacheOptions $options): \Zend\Cache\Storage\Adapter\Memcache
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$options` | **array&#124;\Traversable&#124;\Zend\Cache\Storage\Adapter\MemcacheOptions** |  |
...
```php
public getOptions(): \Zend\Cache\Storage\Adapter\MemcacheOptions
```
...
```php
protected getWriteFlag(mixed& $value): int
```
