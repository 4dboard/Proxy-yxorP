...
```php
protected null|resource $handle
```
...
```php
public __construct(null|array|\Traversable|\Zend\Cache\Storage\Adapter\DbaOptions $options = null): mixed
```
...
|-----------|------|-------------|
| `$options` | **null&#124;array&#124;\Traversable&#124;\Zend\Cache\Storage\Adapter\DbaOptions** |  |
...
```php
public setOptions(array|\Traversable|\Zend\Cache\Storage\Adapter\DbaOptions $options): self
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$options` | **array&#124;\Traversable&#124;\Zend\Cache\Storage\Adapter\DbaOptions** |  |
...
```php
public getOptions(): \Zend\Cache\Storage\Adapter\DbaOptions
```
...
```php
public getIterator(): \Zend\Cache\Storage\Adapter\DbaIterator
```
