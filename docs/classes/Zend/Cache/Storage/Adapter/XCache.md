...
* Full name: `\Zend\Cache\Storage\Adapter\XCache`
...
```php
protected int|float $totalSpace
```
...
```php
public __construct(null|array|\Traversable|\Zend\Cache\Storage\Adapter\XCacheOptions $options = null): mixed
```
...
|-----------|------|-------------|
| `$options` | **null&#124;array&#124;\Traversable&#124;\Zend\Cache\Storage\Adapter\XCacheOptions** |  |
...
```php
public setOptions(array|\Traversable|\Zend\Cache\Storage\Adapter\XCacheOptions $options): \Zend\Cache\Storage\Adapter\XCache
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$options` | **array&#124;\Traversable&#124;\Zend\Cache\Storage\Adapter\XCacheOptions** |  |
...
```php
public getOptions(): \Zend\Cache\Storage\Adapter\XCacheOptions
```
...
```php
protected normalizeMetadata(array& $metadata): mixed
```
