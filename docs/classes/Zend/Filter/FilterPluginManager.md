...
Enforces that filters retrieved are either callbacks or instances of FilterInterface. Additionally, it registers a
number of default filters available, as well as aliases for them.

* Full name: `\Zend\Filter\FilterPluginManager`
