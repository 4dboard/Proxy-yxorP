...
* Full name: `\Zend\Config\ReaderPluginManager`
...
Validate the plugin Checks that the reader loaded is an instance of Reader\ReaderInterface.

```php
public validatePlugin(\Zend\Config\Reader\ReaderInterface $plugin): void
```
...
|-----------|------|-------------|
| `$plugin` | **\Zend\Config\Reader\ReaderInterface** |  |
