...
Enforces that adapters retrieved are instances of Adapter\AdapterInterface. Additionally, it registers a number of
default adapters available.

* Full name: `\Zend\Math\BigInteger\AdapterPluginManager`
