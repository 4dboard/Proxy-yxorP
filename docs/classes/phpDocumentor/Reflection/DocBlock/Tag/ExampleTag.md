...
This function is equivalent to {@link}, except that it convers an URI to a file path before that.
...
|-----------|------|-------------|
| `$lineCount` | **
int&#124;null** | The new number of lines, relative to the<br />starting line. NULL means &quot;to the end&quot;. |
