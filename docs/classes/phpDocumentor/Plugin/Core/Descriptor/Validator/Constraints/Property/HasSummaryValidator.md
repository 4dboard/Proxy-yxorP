...
* Full name: `\phpDocumentor\Plugin\Core\Descriptor\Validator\Constraints\Property\HasSummaryValidator`
* Parent
...
```php
public validate(\phpDocumentor\Descriptor\PropertyDescriptor $value, \Symfony\Component\Validator\Constraint $constraint): mixed
```
...
|-----------|------|-------------|
| `$value` | **\phpDocumentor\Descriptor\PropertyDescriptor** | The value that should be validated |
| `$constraint` | **\Symfony\Component\Validator\Constraint** | The constraint for the validation |
