...
* Full name: `\phpDocumentor\Plugin\Core\Descriptor\Validator\Constraints\Functions\IsArgumentInDocBlockValidator`
* Parent
...
```php
private existsParamTagWithArgument(\phpDocumentor\Plugin\Core\Descriptor\Validator\Constraints\Functions\ParamDescriptor[]|\phpDocumentor\Descriptor\Collection $parameters, \phpDocumentor\Descriptor\ArgumentDescriptor $argument): bool
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$parameters` | **\phpDocumentor\Plugin\Core\Descriptor\Validator\Constraints\Functions\ParamDescriptor[]
