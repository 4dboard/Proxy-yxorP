...
|-----------|------|-------------|
| `$value` | **\phpDocumentor\Descriptor\FileDescriptor&#124;\phpDocumentor\Descriptor\ClassDescriptor&#124;\phpDocumentor\Descriptor\InterfaceDescriptor&#124;\phpDocumentor\Descriptor\TraitDescriptor** | The value that should<br />be validated. |
