...
Defines the name, description and additional options for this command and inherits the behaviour of the parent
configure.
...
This method overrides the parent getConverter method and invokes the configureConverterFromInputOptions() method to set
the options coming from the Input object.
