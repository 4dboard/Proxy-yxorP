...
* Full name: `\phpDocumentor\Plugin\Scrybe\Command\Manual\ToHtmlCommand`
...
Defines the name and description for this command and inherits the behaviour of the parent configure.
