...
|-----------|------|-------------|
| `$matcher` | **
callable** | A callback function accepting the criteria as only parameter and which must<br />return a boolean. |
| `$assembler` | **
\phpDocumentor\Descriptor\Builder\AssemblerInterface** | An instance of the Assembler that will be returned if the callback returns<br />true with the provided criteria. |
