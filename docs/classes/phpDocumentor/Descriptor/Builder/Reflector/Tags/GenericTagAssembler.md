...
* Full name: `\phpDocumentor\Descriptor\Builder\Reflector\Tags\GenericTagAssembler`
...
```php
public create(\phpDocumentor\Reflection\DocBlock\Tag $data): \phpDocumentor\Descriptor\TagDescriptor
```
...
|-----------|------|-------------|
| `$data` | **\phpDocumentor\Reflection\DocBlock\Tag** |  |
