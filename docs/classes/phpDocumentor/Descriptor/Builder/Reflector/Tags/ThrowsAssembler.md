...
This object will read the reflected information for the `@throws` tag and create a {@see} object that can be used in the
rest of the application and templates.

* Full name: `\phpDocumentor\Descriptor\Builder\Reflector\Tags\ThrowsAssembler`
...
```php
public create(\phpDocumentor\Reflection\DocBlock\Tag\ThrowsTag $data): \phpDocumentor\Descriptor\Tag\ThrowsDescriptor
```
...
|-----------|------|-------------|
| `$data` | **\phpDocumentor\Reflection\DocBlock\Tag\ThrowsTag** |  |
