...
This object will read the reflected information for the `@author` tag and create a {@see} object that can be used in the
rest of the application and templates.

* Full name: `\phpDocumentor\Descriptor\Builder\Reflector\Tags\AuthorAssembler`
...
```php
public create(\phpDocumentor\Reflection\DocBlock\Tag\AuthorTag $data): \phpDocumentor\Descriptor\Tag\AuthorDescriptor
```
...
|-----------|------|-------------|
| `$data` | **\phpDocumentor\Reflection\DocBlock\Tag\AuthorTag** |  |
