...
| `$OAuth` | **
\PHPMailer\PHPMailer\OAuthTokenProvider** | An optional OAuthTokenProvider instance for XOAUTH2 authentication |
...
Issues a data command and sends the msg_data to the server, finalizing the mail transaction. $msg_data is the message
