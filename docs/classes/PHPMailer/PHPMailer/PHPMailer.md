...
| `$lang_path` | **
string** | Path to the language file directory, with trailing separator (slash).D<br />Do not set this from user input! |
...
that embed the images the HTML refers to using the $cid value. Never use a user-supplied path to a file!
