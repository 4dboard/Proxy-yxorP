...
* Full name: `\Twig\Node\Expression\ArrayExpression`
...
```php
public __construct(array $elements, mixed $lineno): mixed
```
...
```php
public hasElement(\Twig\Node\Expression\AbstractExpression $key): mixed
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$key` | **\Twig\Node\Expression\AbstractExpression** |  |
...
```php
public addElement(\Twig\Node\Expression\AbstractExpression $value, \Twig\Node\Expression\AbstractExpression $key = null): mixed
```
