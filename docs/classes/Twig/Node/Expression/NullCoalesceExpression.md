...
* Full name: `\Twig\Node\Expression\NullCoalesceExpression`
* Parent class: [`\Twig\Node\Expression\ConditionalExpression`](./ConditionalExpression.md)
...
```php
public __construct(\Twig_NodeInterface $left, \Twig_NodeInterface $right, mixed $lineno): mixed
```
...
|-----------|------|-------------|
| `$left` | **\Twig_NodeInterface** |  |
| `$right` | **\Twig_NodeInterface** |  |
| `$lineno` | **mixed** |  |
