...
* Full name: `\Twig\Node\Expression\MethodCallExpression`
...
```php
public __construct(\Twig\Node\Expression\AbstractExpression $node, mixed $method, \Twig\Node\Expression\ArrayExpression $arguments, mixed $lineno): mixed
```
