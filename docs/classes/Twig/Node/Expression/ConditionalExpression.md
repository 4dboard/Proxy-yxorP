...
* Full name: `\Twig\Node\Expression\ConditionalExpression`
...
```php
public __construct(\Twig\Node\Expression\AbstractExpression $expr1, \Twig\Node\Expression\AbstractExpression $expr2, \Twig\Node\Expression\AbstractExpression $expr3, mixed $lineno): mixed
```
...
| `$expr2` | **\Twig\Node\Expression\AbstractExpression** |  |
| `$expr3` | **\Twig\Node\Expression\AbstractExpression** |  |
| `$lineno` | **mixed** |  |
