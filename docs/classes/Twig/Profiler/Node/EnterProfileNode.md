...
* Full name: `\Twig\Profiler\Node\EnterProfileNode`
* Parent class: [`\Twig\Node\Node`](../../Node/Node.md)
...
```php
public __construct(mixed $extensionName, mixed $type, mixed $name, mixed $varName): mixed
```
