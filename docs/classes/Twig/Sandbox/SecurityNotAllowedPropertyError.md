...
* Full name: `\Twig\Sandbox\SecurityNotAllowedPropertyError`
...
```php
public __construct(mixed $message, mixed $className, mixed $propertyName, mixed $lineno = -1, mixed $filename = null, \Exception $previous = null): mixed
```
