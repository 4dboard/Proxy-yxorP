...
* Full name: `\PhpParser\Node\Expr\ConstFetch`
...
```php
public __construct(\PhpParser\Node\Name $name, array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$name` | **\PhpParser\Node\Name** | Constant name |
