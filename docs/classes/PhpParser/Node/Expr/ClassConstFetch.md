...
* Full name: `\PhpParser\Node\Expr\ClassConstFetch`
...
```php
public __construct(\PhpParser\Node\Name|\PhpParser\Node\Expr $class, string $name, array $attributes = array()): mixed
```
