...
* Full name: `\PhpParser\Node\Expr\Include_`
...
|:---------|:-----------|:-----|:------|
|`TYPE_INCLUDE`|public| |1|
|`TYPE_INCLUDE_ONCE`|public| |2|
|`TYPE_REQUIRE`|public| |3|
|`TYPE_REQUIRE_ONCE`|public| |4|
...
```php
public __construct(\PhpParser\Node\Expr $expr, int $type, array $attributes = array()): mixed
```
