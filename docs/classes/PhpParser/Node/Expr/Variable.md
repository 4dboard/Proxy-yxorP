...
* Full name: `\PhpParser\Node\Expr\Variable`
...
```php
public __construct(string|\PhpParser\Node\Expr $name, array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$name` | **string&#124;\PhpParser\Node\Expr** | Name |
