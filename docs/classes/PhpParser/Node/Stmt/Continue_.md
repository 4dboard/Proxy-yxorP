...
* Full name: `\PhpParser\Node\Stmt\Continue_`
...
```php
public null|\PhpParser\Node\Expr $num
```
...
```php
public __construct(null|\PhpParser\Node\Expr $num = null, array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$num` | **null&#124;\PhpParser\Node\Expr** | Number of loops to continue |
