...
* Full name: `\PhpParser\Node\Stmt\Namespace_`
...
```php
public null|\PhpParser\Node\Name $name
```
...
```php
public __construct(null|\PhpParser\Node\Name $name = null, null|\PhpParser\Node[] $stmts = array(), array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$name` | **null&#124;\PhpParser\Node\Name** | Name |
| `$stmts` | **null&#124;\PhpParser\Node[]** | Statements |
