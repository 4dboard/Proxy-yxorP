...
* Full name: `\PhpParser\Node\Stmt\TraitUse`
...
```php
public \PhpParser\Node\Name[] $traits
```
...
```php
public \PhpParser\Node\Stmt\TraitUseAdaptation[] $adaptations
```
...
```php
public __construct(\PhpParser\Node\Name[] $traits, \PhpParser\Node\Stmt\TraitUseAdaptation[] $adaptations = array(), array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$traits` | **\PhpParser\Node\Name[]** | Traits |
| `$adaptations` | **\PhpParser\Node\Stmt\TraitUseAdaptation[]** | Adaptations |
