...
* Full name: `\PhpParser\Node\Stmt\TraitUseAdaptation\Precedence`
...
```php
public \PhpParser\Node\Name[] $insteadof
```
...
```php
public __construct(\PhpParser\Node\Name $trait, string $method, \PhpParser\Node\Name[] $insteadof, array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$trait` | **\PhpParser\Node\Name** | Trait name |
| `$method` | **string** | Method name |
| `$insteadof` | **\PhpParser\Node\Name[]** | Overwritten traits |
