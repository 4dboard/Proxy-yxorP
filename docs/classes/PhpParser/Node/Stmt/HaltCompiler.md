...
* Full name: `\PhpParser\Node\Stmt\HaltCompiler`
...
```php
public __construct(string $remaining, array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$remaining` | **string** | Remaining text after halt compiler statement. |
