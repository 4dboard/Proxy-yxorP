...
* Full name: `\PhpParser\Node\Stmt\Return_`
...
```php
public null|\PhpParser\Node\Expr $expr
```
...
```php
public __construct(null|\PhpParser\Node\Expr $expr = null, array $attributes = array()): mixed
```
...
|-----------|------|-------------|
| `$expr` | **null&#124;\PhpParser\Node\Expr** | Expression |
