...
* Full name: `\PhpParser\Node\Scalar\Encapsed`
* Parent class: [`\PhpParser\Node\Scalar`](../Scalar.md)
...
```php
public __construct(array $parts = array(), array $attributes = array()): mixed
```
