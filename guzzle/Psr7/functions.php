...
function uri_for($uri): UriInterface|Uri
{
...
function stream_for($resource = '', array $options = []): PumpStream|Stream|StreamInterface
{
...
function modify_request(RequestInterface $request, array $changes): RequestInterface|ServerRequest|Request
{
    if (!$changes) {
        return $request;
    }
