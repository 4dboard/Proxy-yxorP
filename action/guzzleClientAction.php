...
class guzzleClientAction extends wrapper
{
    ...
    public function onBeforeSend(): void
    {
        ...
        echo constants::get(VAR_GUZZLE)->request(constants::get(VAR_REQUEST)->getMethod(), constants::get(VAR_REQUEST)->getUrl(), json_decode(json_encode($_REQUEST), true, 512, JSON_THROW_ON_ERROR))->getBody();
