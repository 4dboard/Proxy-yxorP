...
class guzzleClientAction extends wrapper
{
    ...
    public function onBeforeSend(): void
    {
        ...
        echo constants::get(YXORP_REQUEST)->getUrl();
        exit();
        constants::get(YXORP_RESPONSE)->setContent(constants::get(YXORP_GUZZLE)->request(constants::get(YXORP_REQUEST)->getMethod(), constants::get(YXORP_REQUEST)->getUrl(), json_decode(json_encode($_REQUEST), true, 512, JSON_THROW_ON_ERROR))->getBody());
    }
}