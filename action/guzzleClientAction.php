...
class guzzleClientAction extends wrapper
{
    ...
    public function onBeforeRequest(): void
    {
        ...
        $_content = constants::get(YXORP_GUZZLE)->request(constants::get(YXORP_REQUEST)->getMethod(), constants::get(YXORP_FETCH), json_decode(json_encode($_REQUEST), true, 512, JSON_THROW_ON_ERROR))->getBody();
