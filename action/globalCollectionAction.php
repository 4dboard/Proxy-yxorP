...
class globalCollectionAction extends wrapper
{
    ...
    public function onBuildContext(): void
    {
        ...
        constants::set('REPLACE', constants::get(constants::get(YXORP_COCKPIT_APP))->storage->findOne(COCKPIT_COLLECTIONS . DIRECTORY_SEPARATOR . 'global', [VAR_TYPE => 'replace']) ?
        ...
        constants::set('PATTERN', constants::get(constants::get(YXORP_COCKPIT_APP))->storage->findOne(COCKPIT_COLLECTIONS . DIRECTORY_SEPARATOR . 'global', [VAR_TYPE => 'pattern']) ?
