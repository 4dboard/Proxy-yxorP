...
class globalCollectionAction extends wrapper
{
    ...
    public function onBuildContext(): void
    {
        ...
        constants::set('GLOBAL_REPLACE', constants::get(constants::get(YXORP_COCKPIT_APP))->storage->findOne(COCKPIT_COLLECTIONS . DIRECTORY_SEPARATOR . 'global', [VAR_TYPE => 'replace']) ?
        ...
        constants::set('GLOBAL_PATTERN', constants::get(constants::get(YXORP_COCKPIT_APP))->storage->findOne(COCKPIT_COLLECTIONS . DIRECTORY_SEPARATOR . 'global', [VAR_TYPE => 'pattern']) ?
