...
//        constants::set(YXORP_FETCH, VAR_HTTPS . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . ((!is_null(constants::get(YXORP_SITE_SUB_DOMAIN))) ? (constants::get(YXORP_SITE_SUB_DOMAIN) . ".") : null) . constants::get(YXORP_TARGET_DOMAIN));
