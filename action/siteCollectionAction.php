...
class siteCollectionAction extends wrapper
{
    ...
    public function onBuildContext(): void
    {
        ...
        constants::set(YXORP_TARGET, constants::get(constants::get(YXORP_COCKPIT_APP))->storage->findOne(COCKPIT_COLLECTIONS . DIRECTORY_SEPARATOR . COCKPIT_SITES, ['host' => constants::get(YXORP_SITE_DOMAIN)]));
        ...
        constants::set(YXORP_FETCH, 'https:' . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . ((!is_null(constants::get(YXORP_SITE_SUB_DOMAIN))) ? (constants::get(YXORP_SITE_SUB_DOMAIN)->__toString() . ".") : null) . constants::get(YXORP_TARGET_DOMAIN)->__toString());
        ...
        constants::set(YXORP_DIR_FULL, DIR_ROOT . 'override' . DIRECTORY_SEPARATOR . constants::get(YXORP_TARGET)['files']);
    }
}