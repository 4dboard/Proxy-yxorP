...
const SYSTEM_USERS = COCKPIT_YXORP . CHAR_SLASH . VAR_COCKPIT_LOGS;
const SYSTEM_USERS = SYSTEM_YXORP . CHAR_SLASH . VAR_SYSTEM_USERS;
...
const DIR_ACCOUNTS = VAR_SYSTEM_USERS . DIRECTORY_SEPARATOR;
