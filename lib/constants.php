...
const YXORP_APP = 'system';
const YXORP_APP_USERS = YXORP_APP . CHAR_SLASH . VAR_APP_LOGS;
const YXORP_APP_USERS = YXORP_APP . CHAR_SLASH . VAR_USERS;
...
const DIR_COCKPIT = YXORP_APP . DIRECTORY_SEPARATOR;
