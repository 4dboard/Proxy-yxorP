...
const YXORP_APP_SYSTEM = 'system';
const YXORP_APP_SYSTEM_USERS = YXORP_APP_SYSTEM . CHAR_SLASH . VAR_APP_LOGS;
const YXORP_APP_SYSTEM_USERS = YXORP_APP_SYSTEM . CHAR_SLASH . VAR_USERS;
const APP_CONTENT = 'content';
const APP_SINGLETONS = 'singletons';
const APP_KEY = 'key';
...
const DIR_APP = 'cockpit' . DIRECTORY_SEPARATOR;
...
const FILE_APP_BOOTSTRAP = 'bootstrap' . EXT_PHP;
...
const YXORP_APP_SYSTEM_INSTALL = VAR_COCKPIT . CHAR_UNDER . VAR_INSTALL;
const YXORP_APP_SYSTEM = VAR_COCKPIT . CHAR_UNDER . VAR_APP;
...
const ENV_ADMIN_USER = 'APP_USER' . EXT_ENV;
const ENV_ADMIN_NAME = 'APP_NAME' . EXT_ENV;
const ENV_ADMIN_EMAIL = 'APP_EMAIL' . EXT_ENV;
const ENV_ADMIN_PASSWORD = 'APP_PASSWORD' . EXT_ENV;
