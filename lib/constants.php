...
const VAR_COCKPIT_LOGS = 'logs';
const VAR_YXORP_APP_SYSTEM__USERS = 'users';
...
const SYSTEM_YXORP = 'system';
const YXORP_APP_SYSTEM__USERS = COCKPIT_YXORP . CHAR_SLASH . VAR_COCKPIT_LOGS;
const YXORP_APP_SYSTEM__USERS = SYSTEM_YXORP . CHAR_SLASH . VAR_YXORP_APP_SYSTEM__USERS;
const COCKPIT_COLLECTIONS = 'collections';
const COCKPIT_SINGLETONS = 'singletons';
const COCKPIT_KEY = 'key';
const COCKPIT_SETTINGS = 'Settings';
const COCKPIT_VAL = 'val';
const COCKPIT_SITES = 'sites';
const COCKPIT_HOST = 'host';
const COCKPIT_NAME = 'name';
...
const DIR_ACCOUNTS = VAR_YXORP_APP_SYSTEM__USERS . DIRECTORY_SEPARATOR;
...
const YXORP_APP = VAR_COCKPIT . CHAR_UNDER . VAR_APP;
