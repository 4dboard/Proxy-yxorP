...
const APP_YXORP = 'cockpit';
const SYSTEM_YXORP = 'system';
const YXORP_APP_USERS = APP_YXORP . CHAR_SLASH . VAR_APP_LOGS;
...
const DIR_COCKPIT = APP_YXORP . DIRECTORY_SEPARATOR;
...
const YXORP_APP_INSTALL = VAR_COCKPIT . CHAR_UNDER . VAR_INSTALL;
