...
class publicSuffixListManager
{
    ...
    protected static $domainList = [self::ALL_DOMAINS => PATH_PDP_PSL_PHP_FILE, self::ICANN_DOMAINS => PATH_ICANN_PSL_PHP_FILE, self::PRIVATE_DOMAINS => PATH_PRIVATE_PSL_PHP_FILE,];
